...
* Потребляемый ток при приёме: ~0.65А
...
Поддерживаются дисплеи ILI9481, ILI9486 и HX8357B
...
* **RF GAIN xx** - Калибровка максимальной выходной мощности на каждый диапазон (<2mhz LF, <5mhz HF_LOW, <30mhz HF, <94mhz HF_HIGH, >94mhz VHF)
...
### Band SWR - Запуск анализатора КСВ в текущем диапазоне

### HF SWR - Запуск анализатора КСВ во всём КВ диапазоне

### RDA Statistics - Отображение статистики по диплому RDA
