...
* **FFT Top** - Верхний уровень чувствительности FFT (чем меньше - тем сигналы контрастней, 30 - выравнивание по сильнейшему сигналу)
...
* **FFT HiRes** - Повышение разрешения ZoomFFT за счёт большего накопления данных
