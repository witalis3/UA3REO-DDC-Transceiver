...
* **FFT Automatic** - Автоматическая подстройка шкалы FFT. Full - автоматический выбор верхней и нижней границ, Half - авто верхний и ручной нижний, No - ручное выставление диапазона уровней спектра. (Не забывайте выбрать нужный FFT Scale Type, чтобы диапазон уместился на экране)
