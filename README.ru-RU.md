...
* **AM/FM LPF Stages** - Регулировка скатов LPF-фильтров AM/NFM
...
* **TX CESSB** - Использование модуляции с контролем огибающей при формировании SSB сигнала
* **TX CESSB Compress, dB** - Уровень компрессии сигнала CESSB
...
* **ALC Port Enabled** - Активация управления мощностью трансивера внешним усилителем по линии ALC: до 1 вольта - ALC отключен и используется мощность выставленная в трансивере. с 1.0v до 3.3v - регулировка мощности от 0 до 100 %
