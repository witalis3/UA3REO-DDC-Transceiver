...
* Мощность TX (QRP-7W версия): 7W+ (HF), 5W (VHF)
* Мощность TX (BIG-35W версия): 35W+ (HF), 35W+ (VHF)
* Два Антенных входа
...
* **CW Pitcht** - Отстройка генератора приёма от частоты передачи
...
* Запуск файлового менеджера по SD карте памяти, функции проигрывания и удаления файлов
