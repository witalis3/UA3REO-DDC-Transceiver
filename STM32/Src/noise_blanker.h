...
#define NB_SIGNAL_SMOOTH 0.08f   // reaction filter
#define NB_EDGES_SMOOTH 0.5f     // edges smooth filter
#define NB_DELAY_BUFFER_ITEMS 30 // delay zero samples
// NB2
#define NB_c1 0.92f          // averaging coefficients
...
#define NB_impulse_length 7                      // has to be odd !
#define NB_PL ((TRX.NB3_impulse_length - 1) / 2) // has to be (impulse_length-1) / 2
#define NB_order 32                              // 10                         // lpc's order
