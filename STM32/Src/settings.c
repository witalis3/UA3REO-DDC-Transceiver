...
void LoadSettings(bool clear) {
	...
	if (TRX.flash_id != SETT_VERSION || clear || TRX.ENDBit != 100 || TRX.csum != calculateCSUM()) // code to trace new clean flash
	{
		...
		TRX.RX_EQ_P1 = 1;                   // Receiver Equalizer 300hz
		TRX.RX_EQ_P2 = 0;                   // Receiver Equalizer 700hz
		TRX.RX_EQ_P3 = -3;                  // Receiver Equalizer 1200hz
		TRX.RX_EQ_P4 = 0;                   // Receiver Equalizer 1800hz
		TRX.RX_EQ_P5 = -5;                  // Receiver Equalizer 2300hz
		TRX.RX_EQ_P1_WFM = 0;               // Receiver WFM Equalizer 50hz
		TRX.RX_EQ_P2_WFM = 0;               // Receiver WFM Equalizer 300hz
		TRX.RX_EQ_P3_WFM = -6;              // Receiver WFM Equalizer 1500hz
		TRX.RX_EQ_P4_WFM = -3;              // Receiver WFM Equalizer 5000hz
		TRX.RX_EQ_P5_WFM = -2;              // Receiver WFM Equalizer 8000hz
		TRX.RX_EQ_P6_WFM = -1;              // Receiver WFM Equalizer 12000hz
		TRX.MIC_EQ_P1_SSB = -6;             // Mic EQ SSB
		TRX.MIC_EQ_P2_SSB = -4;             // Mic EQ SSB
		TRX.MIC_EQ_P3_SSB = 5;              // Mic EQ SSB
		TRX.MIC_EQ_P4_SSB = 3;              // Mic EQ SSB
		TRX.MIC_EQ_P5_SSB = 1;              // Mic EQ SSB
		TRX.MIC_EQ_P1_AMFM = -6;            // Mic EQ AM/FM
		TRX.MIC_EQ_P2_AMFM = -4;            // Mic EQ AM/FM
		TRX.MIC_EQ_P3_AMFM = 5;             // Mic EQ AM/FM
		TRX.MIC_EQ_P4_AMFM = 3;             // Mic EQ AM/FM
		TRX.MIC_EQ_P5_AMFM = 1;             // Mic EQ AM/FM
