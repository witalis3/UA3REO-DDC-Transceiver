...
//LCD_ILI9481 / LCD_HX8357B
	...
	// FFT and waterfall
	#define LAY_FFT_HEIGHT_STYLE1 50  // specify the maximum FFT height
	#define LAY_WTF_HEIGHT_STYLE1 130 // specify the maximum height of the waterfall (262max)
	#define LAY_FFT_HEIGHT_STYLE2 76 // specify the maximum FFT height
	#define LAY_WTF_HEIGHT_STYLE2 130  // specify the maximum height of the waterfall (236max)
	#define LAY_FFT_HEIGHT_STYLE3 102 // specify the maximum FFT height
