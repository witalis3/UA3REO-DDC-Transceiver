...
#define LAY_TEXTBAR_TEXT_X_OFFSET 85
	...
	// FFT and waterfall
	#define LAY_FFT_HEIGHT_STYLE1 70  // specify the maximum FFT height
	#define LAY_WTF_HEIGHT_STYLE1 180 // specify the maximum height of the waterfall (262max)
	#define LAY_FFT_HEIGHT_STYLE2 90 // specify the maximum FFT height
	#define LAY_WTF_HEIGHT_STYLE2 160  // specify the maximum height of the waterfall (236max)
	#define LAY_FFT_HEIGHT_STYLE3 120 // specify the maximum FFT height
	#define LAY_WTF_HEIGHT_STYLE3 130  // specify the maximum height of the waterfall (210max)
	#define LAY_FFT_PRINT_SIZE LCD_WIDTH                                           // specify the width of the displayed FFT
	#define LAY_FFT_CWDECODER_OFFSET 17                                            // space for the text of the CW decoder
#endif
