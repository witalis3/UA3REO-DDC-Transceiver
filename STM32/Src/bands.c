...
const BAND_MAP BANDS[BANDS_COUNT] =
	{
		...
		//80METERS
		{
			...
			.endFreq = 3800000,
			.regions = (const REGION_MAP[]){
				{.startFreq = 3500000, .endFreq = 3580000, .mode = TRX_MODE_CW_L},
				{.startFreq = 3580000, .endFreq = 3600000, .mode = TRX_MODE_DIGI_U},
		...
		//30METERS
		{
			...
			.endFreq = 10150000,
			.regions = (const REGION_MAP[]){
				{.startFreq = 10100000, .endFreq = 10140000, .mode = TRX_MODE_CW_U},
				{.startFreq = 10140000, .endFreq = 10150000, .mode = TRX_MODE_DIGI_U},
			},
			.regionsCount = 2,
		},
		//20METERS
		...
		//17METERS
		{
			...
			.regions = (const REGION_MAP[]){
				...
				{.startFreq = 18095000, .endFreq = 18109000, .mode = TRX_MODE_DIGI_U},
				{.startFreq = 18109000, .endFreq = 18168000, .mode = TRX_MODE_USB},
			},
			.regionsCount = 3,
		},
		//15METERS
		...
		//10METERS
		{
			...
			.regions = (const REGION_MAP[]){
				...
				{.startFreq = 28190000, .endFreq = 28199000, .mode = TRX_MODE_CW_U},
				{.startFreq = 28199000, .endFreq = 28300000, .mode = TRX_MODE_USB},
				{.startFreq = 28300000, .endFreq = 28320000, .mode = TRX_MODE_DIGI_U},
				{.startFreq = 28320000, .endFreq = 29200000, .mode = TRX_MODE_USB},
		...
		//FM RADIO 1
		{
			...
			.endFreq = 74000000,
			.regions = (const REGION_MAP[]){
				{.startFreq = 65900000, .endFreq = 74000000, .mode = TRX_MODE_WFM},
			},
			.regionsCount = 1,
		},
		//FM RADIO 2
		{
			...
			.endFreq = 108000000,
			.regions = (const REGION_MAP[]){
				{.startFreq = 87500000, .endFreq = 108000000, .mode = TRX_MODE_WFM},
			},
			.regionsCount = 1,
		},
		//2 meter
		{
			...
			.endFreq = 146000000,
			.regions = (const REGION_MAP[]){
				{.startFreq = 144000000, .endFreq = 144025000, .mode = TRX_MODE_NFM},
				{.startFreq = 144025000, .endFreq = 144110000, .mode = TRX_MODE_CW_U},
