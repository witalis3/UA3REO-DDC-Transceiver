...
extern "C" constexpr STRUCT_LAYOUT_THEME LAYOUT_THEMES[LAYOUT_THEMES_COUNT] =
	{
		// Default
		{
			...
			#endif
			#ifdef STM32F407xx
			.FFT_HEIGHT_STYLE1 = 20,
			.WTF_HEIGHT_STYLE1 = 20,
			.FFT_HEIGHT_STYLE2 = 20,
			.WTF_HEIGHT_STYLE2 = 20,
			.FFT_HEIGHT_STYLE3 = 20,
			.WTF_HEIGHT_STYLE3 = 20,
			.FFT_HEIGHT_STYLE4 = 20,
			.WTF_HEIGHT_STYLE4 = 20,
			.FFT_HEIGHT_STYLE5 = 20,
			.WTF_HEIGHT_STYLE5 = 20,
			#endif
