...
extern "C" constexpr STRUCT_LAYOUT_THEME LAYOUT_THEMES[LAYOUT_THEMES_COUNT] =
	{
		// Default
		{
			...
			.WTF_HEIGHT_STYLE1 = 10,
			.FFT_HEIGHT_STYLE2 = 10,
			.WTF_HEIGHT_STYLE2 = 10,
			.FFT_HEIGHT_STYLE3 = 10,
			.WTF_HEIGHT_STYLE3 = 10,
			.FFT_HEIGHT_STYLE4 = 10,
			.WTF_HEIGHT_STYLE4 = 10,
			.FFT_HEIGHT_STYLE5 = 10,
