...
void TRX_DBMCalculate(void)
{
	...
	float32_t ADC_RF_IN_Value = (ADC_Vrms_Value / ADC_RF_TRANS_RATIO)*CALIBRATE.adc_calibration; //Получаем напряжение на антенном входе с учётом трансформатора и калибровки
