    ...
    case USB_DESC_TYPE_STRING:
      switch ((uint8_t)(req->wValue))
      {
        ...
        case USBD_IDX_INTERFACE1_STR:
          if (pdev->pDesc->GetInterface1StrDescriptor != NULL)
          {
          ...
          if (pdev->pDesc->GetInterface2StrDescriptor != NULL)
          {
          ...
          if (pdev->pDesc->GetInterface3StrDescriptor != NULL)
          {
          ...
          if (pdev->pDesc->GetInterface4StrDescriptor != NULL)
          {
