...
void WIFI_checkFWUpdates(void) {
	...
	char url[128];
	sprintf(url, "/trx_services/check_fw_updates_2.php?dev=0&stm32=%s&fpga=%d.%d.%d&lcd=%s&callsign=%s", version_string, FPGA_FW_Version[2], FPGA_FW_Version[1], FPGA_FW_Version[0], ota_config_lcd, TRX.CALLSIGN);
