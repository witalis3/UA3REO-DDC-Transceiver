...
#define FFT_MAX ((float32_t)TRX.FFT_Sensitivity * 1.5f)                                                                                                      // MAX FFT signal threshold
...
#define FFT_MAX_MEANS 10      //store old fft data for averaging
...
#define FFT_DBM_COMPENSATION 5.0f	//for amplitude conversion
