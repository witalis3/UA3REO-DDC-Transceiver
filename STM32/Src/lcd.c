...
// display information about the operation of the transceiver
	...
	printButton(LAYOUT->TOPBUTTONS_DNR_X, LAYOUT->TOPBUTTONS_DNR_Y, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "DNR", CurrentVFO->DNR, true, false, 0, FRONTPANEL_BUTTONHANDLER_DNR, FRONTPANEL_BUTTONHANDLER_DNR_HOLD, COLOR->BUTTON_TEXT, COLOR->BUTTON_INACTIVE_TEXT);
