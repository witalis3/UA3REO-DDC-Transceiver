...
{ // display the top buttons
	...
	#else
	printInfo(LAY_TOPBUTTONS_PRE_X, LAY_TOPBUTTONS_PRE_Y, LAY_TOPBUTTONS_PRE_W, LAY_TOPBUTTONS_PRE_H, "PRE", COLOR_THEME->COLOR_BUTTON_BACKGROUND, COLOR_THEME->COLOR_BUTTON_TEXT, COLOR_THEME->COLOR_BUTTON_INACTIVE_TEXT, TRX.LNA);
	char buff[64] = {0};
	sprintf(buff, "ATT%d", (uint8_t)TRX.ATT_DB);
	if (TRX.ATT_DB == 0)
		sprintf(buff, "ATT");
	printInfo(LAY_TOPBUTTONS_ATT_X, LAY_TOPBUTTONS_ATT_Y, LAY_TOPBUTTONS_ATT_W, LAY_TOPBUTTONS_ATT_H, buff, COLOR_THEME->COLOR_BUTTON_BACKGROUND, COLOR_THEME->COLOR_BUTTON_TEXT, COLOR_THEME->COLOR_BUTTON_INACTIVE_TEXT, TRX.ATT);
	printInfo(LAY_TOPBUTTONS_PGA_X, LAY_TOPBUTTONS_PGA_Y, LAY_TOPBUTTONS_PGA_W, LAY_TOPBUTTONS_PGA_H, "PGA", COLOR_THEME->COLOR_BUTTON_BACKGROUND, COLOR_THEME->COLOR_BUTTON_TEXT, COLOR_THEME->COLOR_BUTTON_INACTIVE_TEXT, TRX.ADC_PGA);
	printInfo(LAY_TOPBUTTONS_DRV_X, LAY_TOPBUTTONS_DRV_Y, LAY_TOPBUTTONS_DRV_W, LAY_TOPBUTTONS_DRV_H, "DRV", COLOR_THEME->COLOR_BUTTON_BACKGROUND, COLOR_THEME->COLOR_BUTTON_TEXT, COLOR_THEME->COLOR_BUTTON_INACTIVE_TEXT, TRX.ADC_Driver);
	printInfo(LAY_TOPBUTTONS_FAST_X, LAY_TOPBUTTONS_FAST_Y, LAY_TOPBUTTONS_FAST_W, LAY_TOPBUTTONS_FAST_H, "FAST", COLOR_THEME->COLOR_BUTTON_BACKGROUND, COLOR_THEME->COLOR_BUTTON_TEXT, COLOR_THEME->COLOR_BUTTON_INACTIVE_TEXT, TRX.Fast);
	printInfo(LAY_TOPBUTTONS_AGC_X, LAY_TOPBUTTONS_AGC_Y, LAY_TOPBUTTONS_AGC_W, LAY_TOPBUTTONS_AGC_H, "AGC", COLOR_THEME->COLOR_BUTTON_BACKGROUND, COLOR_THEME->COLOR_BUTTON_TEXT, COLOR_THEME->COLOR_BUTTON_INACTIVE_TEXT, CurrentVFO()->AGC);
	printInfo(LAY_TOPBUTTONS_DNR_X, LAY_TOPBUTTONS_DNR_Y, LAY_TOPBUTTONS_DNR_W, LAY_TOPBUTTONS_DNR_H, "DNR", COLOR_THEME->COLOR_BUTTON_BACKGROUND, COLOR_THEME->COLOR_BUTTON_TEXT, COLOR_THEME->COLOR_BUTTON_INACTIVE_TEXT, CurrentVFO()->DNR);
	printInfo(LAY_TOPBUTTONS_NB_X, LAY_TOPBUTTONS_NB_Y, LAY_TOPBUTTONS_NB_W, LAY_TOPBUTTONS_NB_H, "NB", COLOR_THEME->COLOR_BUTTON_BACKGROUND, COLOR_THEME->COLOR_BUTTON_TEXT, COLOR_THEME->COLOR_BUTTON_INACTIVE_TEXT, TRX.NOISE_BLANKER);
	printInfo(LAY_TOPBUTTONS_MUTE_X, LAY_TOPBUTTONS_MUTE_Y, LAY_TOPBUTTONS_MUTE_W, LAY_TOPBUTTONS_MUTE_H, "MUTE", COLOR_THEME->COLOR_BUTTON_BACKGROUND, COLOR_THEME->COLOR_BUTTON_TEXT, COLOR_THEME->COLOR_BUTTON_INACTIVE_TEXT, TRX_Mute);
	printInfo(LAY_TOPBUTTONS_LOCK_X, LAY_TOPBUTTONS_LOCK_Y, LAY_TOPBUTTONS_LOCK_W, LAY_TOPBUTTONS_LOCK_H, "LOCK", COLOR_THEME->COLOR_BUTTON_BACKGROUND, COLOR_THEME->COLOR_BUTTON_TEXT, COLOR_THEME->COLOR_BUTTON_INACTIVE_TEXT, TRX.Locked);
	#endif
...
{ // display the frequency on the screen
	...
	{
		LCDDriver_printTextFont(LCD_freq_string_mhz, mhz_x_offset, LAY_FREQ_Y_BASELINE, COLOR_THEME->LAY_FREQ_COLOR_MHZ, BG_COLOR, LAY_FREQ_FONT);
	...
	if (redraw || (LCD_last_showed_freq_khz != khz))
	{
		...
		LCDDriver_printTextFont(buff, LAY_FREQ_X_OFFSET_KHZ, LAY_FREQ_Y_BASELINE, COLOR_THEME->LAY_FREQ_COLOR_KHZ, BG_COLOR, LAY_FREQ_FONT);
		LCD_last_showed_freq_khz = khz;
	}
	if (redraw || (LCD_last_showed_freq_hz != hz))
	{
		addSymbols(buff, LCD_freq_string_hz, 3, "0", false);
		LCDDriver_printTextFont(buff, LAY_FREQ_X_OFFSET_HZ, LAY_FREQ_Y_BASELINE_SMALL, COLOR_THEME->LAY_FREQ_COLOR_HZ, BG_COLOR, LAY_FREQ_SMALL_FONT);
...
static void LCD_drawSMeter(void)
{
	...
	LCDDriver_printText("S", LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 0.0f) - 2, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_BAR_LABELS_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	LCDDriver_printText("1", LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 1.0f) - 2, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_BAR_LABELS_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	LCDDriver_printText("3", LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 3.0f) - 2, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_BAR_LABELS_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	LCDDriver_printText("5", LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 5.0f) - 2, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_BAR_LABELS_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	LCDDriver_printText("7", LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 7.0f) - 2, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_BAR_LABELS_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	LCDDriver_printText("9", LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 9.0f) - 2, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_BAR_LABELS_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	LCDDriver_printText("+20", LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 11.0f) - 10, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_BAR_LABELS_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	LCDDriver_printText("+40", LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 13.0f) - 10, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_BAR_LABELS_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	LCDDriver_printText("+60", LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 15.0f) - 10, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_BAR_LABELS_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	for (uint8_t i = 0; i <= 15; i ++)
	{
		uint16_t color = COLOR_THEME->LAY_STATUS_BAR_LEFT_COLOR;
		if (i >= 9)
			color = COLOR_THEME->LAY_STATUS_BAR_RIGHT_COLOR;
		if ((i % 2) != 0 || i == 0)
		{
	...
	// S-meter frame
	LCDDriver_drawRectXY(LAY_STATUS_BAR_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET, LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 9.0f) - 2, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + 1, COLOR_THEME->LAY_STATUS_BAR_LEFT_COLOR);
	LCDDriver_drawRectXY(LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 9.0f) - 1, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET, LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_SMETER_WIDTH, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + 1, COLOR_THEME->LAY_STATUS_BAR_RIGHT_COLOR);
	LCDDriver_drawRectXY(LAY_STATUS_BAR_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + LAY_STATUS_BAR_HEIGHT, LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 9.0f) - 2, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + LAY_STATUS_BAR_HEIGHT + 1, COLOR_THEME->LAY_STATUS_BAR_LEFT_COLOR);
	LCDDriver_drawRectXY(LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 9.0f) - 1, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + LAY_STATUS_BAR_HEIGHT, LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_SMETER_WIDTH, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + LAY_STATUS_BAR_HEIGHT + 1, COLOR_THEME->LAY_STATUS_BAR_RIGHT_COLOR);
}
...
static void LCD_displayStatusInfoGUI(void)
{
	...
	{
		if (TRX_Tune)
			LCDDriver_printTextFont("TU", LAY_STATUS_TXRX_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_TXRX_Y_OFFSET), COLOR_THEME->LAY_STATUS_TX_COLOR, BG_COLOR, LAY_STATUS_TXRX_FONT);
		else
			LCDDriver_printTextFont("TX", LAY_STATUS_TXRX_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_TXRX_Y_OFFSET), COLOR_THEME->LAY_STATUS_TX_COLOR, BG_COLOR, LAY_STATUS_TXRX_FONT);

		// frame of the SWR meter
		const float32_t step = LAY_STATUS_PMETER_WIDTH / 16.0f;
		LCDDriver_drawRectXY(LAY_STATUS_BAR_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET, LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 9.0f) , LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + 1, COLOR_THEME->LAY_STATUS_BAR_LEFT_COLOR);
		LCDDriver_drawRectXY(LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 9.0f), LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET, LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_PMETER_WIDTH, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + 1, COLOR_THEME->LAY_STATUS_BAR_RIGHT_COLOR);
		LCDDriver_drawRectXY(LAY_STATUS_BAR_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + LAY_STATUS_BAR_HEIGHT, LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 9.0f), LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + LAY_STATUS_BAR_HEIGHT + 1, COLOR_THEME->LAY_STATUS_BAR_LEFT_COLOR);
		LCDDriver_drawRectXY(LAY_STATUS_BAR_X_OFFSET + (uint32_t)(step * 9.0f), LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + LAY_STATUS_BAR_HEIGHT, LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_PMETER_WIDTH, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + LAY_STATUS_BAR_HEIGHT + 1, COLOR_THEME->LAY_STATUS_BAR_RIGHT_COLOR);
		...
		LCDDriver_printText("SWR:", LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_TX_LABELS_OFFSET_X, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_LABELS_TX_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
		LCDDriver_printText("FWD:", LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_TX_LABELS_OFFSET_X + LAY_STATUS_TX_LABELS_MARGIN_X, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_LABELS_TX_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
		LCDDriver_printText("REF:", LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_TX_LABELS_OFFSET_X + LAY_STATUS_TX_LABELS_MARGIN_X * 2, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_LABELS_TX_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);

		// frame of the ALC meter
		LCDDriver_drawRectXY(LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_PMETER_WIDTH + LAY_STATUS_ALC_BAR_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET, LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_PMETER_WIDTH + LAY_STATUS_ALC_BAR_X_OFFSET + LAY_STATUS_AMETER_WIDTH, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + 1, COLOR_THEME->LAY_STATUS_BAR_LEFT_COLOR);
		LCDDriver_drawRectXY(LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_PMETER_WIDTH + LAY_STATUS_ALC_BAR_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + LAY_STATUS_BAR_HEIGHT, LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_PMETER_WIDTH + LAY_STATUS_ALC_BAR_X_OFFSET + LAY_STATUS_AMETER_WIDTH, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + LAY_STATUS_BAR_HEIGHT + 1, COLOR_THEME->LAY_STATUS_BAR_LEFT_COLOR);
		LCDDriver_printText("ALC:", LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_PMETER_WIDTH + LAY_STATUS_ALC_BAR_X_OFFSET + LAY_STATUS_TX_LABELS_OFFSET_X, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_LABELS_TX_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	}
	else
	{
		LCD_drawSMeter();
		LCDDriver_printTextFont("RX", LAY_STATUS_TXRX_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_TXRX_Y_OFFSET), COLOR_THEME->LAY_STATUS_RX_COLOR, BG_COLOR, LAY_STATUS_TXRX_FONT);
		//Frequency delimiters
		LCDDriver_printTextFont(".", LAY_FREQ_DELIMITER_X1_OFFSET, LAY_FREQ_Y_BASELINE + LAY_FREQ_DELIMITER_Y_OFFSET, COLOR_THEME->LAY_FREQ_COLOR_KHZ, BG_COLOR, LAY_FREQ_FONT);
		LCDDriver_printTextFont(".", LAY_FREQ_DELIMITER_X2_OFFSET, LAY_FREQ_Y_BASELINE + LAY_FREQ_DELIMITER_Y_OFFSET, COLOR_THEME->LAY_FREQ_COLOR_HZ, BG_COLOR, LAY_FREQ_FONT);
		#if (defined(LAY_800x480))
	...
	{
		if (!TRX.Dual_RX)
			printInfo(LAY_STATUS_VFO_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_VFO_Y_OFFSET), LAY_STATUS_VFO_BLOCK_WIDTH, LAY_STATUS_VFO_BLOCK_HEIGHT, "A", COLOR_THEME->LAY_STATUS_VFO_BGCOLOR, COLOR_THEME->LAY_STATUS_VFO_COLOR, COLOR_THEME->LAY_STATUS_VFO_COLOR, true);
		else if (TRX.Dual_RX_Type == VFO_A_AND_B)
			printInfo(LAY_STATUS_VFO_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_VFO_Y_OFFSET), LAY_STATUS_VFO_BLOCK_WIDTH, LAY_STATUS_VFO_BLOCK_HEIGHT, "A&B", COLOR_THEME->LAY_STATUS_VFO_BGCOLOR, COLOR_THEME->LAY_STATUS_VFO_COLOR, COLOR_THEME->LAY_STATUS_VFO_COLOR, true);
	...
	{
		if (!TRX.Dual_RX)
			printInfo(LAY_STATUS_VFO_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_VFO_Y_OFFSET), LAY_STATUS_VFO_BLOCK_WIDTH, LAY_STATUS_VFO_BLOCK_HEIGHT, "B", COLOR_THEME->LAY_STATUS_VFO_BGCOLOR, COLOR_THEME->LAY_STATUS_VFO_COLOR, COLOR_THEME->LAY_STATUS_VFO_COLOR, true);
		else if (TRX.Dual_RX_Type == VFO_A_AND_B)
			printInfo(LAY_STATUS_VFO_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_VFO_Y_OFFSET), LAY_STATUS_VFO_BLOCK_WIDTH, LAY_STATUS_VFO_BLOCK_HEIGHT, "B&A", COLOR_THEME->LAY_STATUS_VFO_BGCOLOR, COLOR_THEME->LAY_STATUS_VFO_COLOR, COLOR_THEME->LAY_STATUS_VFO_COLOR, true);
		else if (TRX.Dual_RX_Type == VFO_A_PLUS_B)
			printInfo(LAY_STATUS_VFO_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_VFO_Y_OFFSET), LAY_STATUS_VFO_BLOCK_WIDTH, LAY_STATUS_VFO_BLOCK_HEIGHT, "B+A", COLOR_THEME->LAY_STATUS_VFO_BGCOLOR, COLOR_THEME->LAY_STATUS_VFO_COLOR, COLOR_THEME->LAY_STATUS_VFO_COLOR, true);
	}
	
	//Mode indicator
	printInfo(LAY_STATUS_MODE_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_MODE_Y_OFFSET), LAY_STATUS_MODE_BLOCK_WIDTH, LAY_STATUS_MODE_BLOCK_HEIGHT, (char *)MODE_DESCR[CurrentVFO()->Mode], BG_COLOR, COLOR_THEME->LAY_STATUS_MODE_COLOR, COLOR_THEME->LAY_STATUS_MODE_COLOR, true);
	#if (defined(LAY_800x480))
	...
	{
		LCDDriver_Fill_RectWH(0, LCD_HEIGHT - LAY_FFT_CWDECODER_OFFSET, LAY_FFT_PRINT_SIZE, LAY_FFT_CWDECODER_OFFSET, BG_COLOR);
		LCD_UpdateQuery.TextBar = true;
	}

	//ANT indicator
	printInfoSmall(LAY_STATUS_ANT_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_ANT_Y_OFFSET), LAY_STATUS_ANT_BLOCK_WIDTH, LAY_STATUS_ANT_BLOCK_HEIGHT, (TRX.ANT ? "ANT2" : "ANT1"), BG_COLOR, COLOR_THEME->LAY_STATUS_RX_COLOR, COLOR_THEME->LAY_STATUS_RX_COLOR, true);
	
	//WIFI indicator
	if (WIFI_connected)
		LCDDriver_printImage_RLECompressed(LAY_STATUS_WIFI_ICON_X, LAY_STATUS_WIFI_ICON_Y, &IMAGES_wifi_active, COLOR_BLACK, BG_COLOR);
	else
		LCDDriver_printImage_RLECompressed(LAY_STATUS_WIFI_ICON_X, LAY_STATUS_WIFI_ICON_Y, &IMAGES_wifi_inactive, COLOR_BLACK, BG_COLOR);
...
static void LCD_displayStatusInfoBar(bool redraw)
{
	...
	if (!TRX_on_TX())
	{
		...
		if (redraw || (LCD_last_s_meter != s_width))
		{
			...
			// bar
			LCDDriver_Fill_RectWH(LAY_STATUS_BAR_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + 2, (uint16_t)s_width, LAY_STATUS_BAR_HEIGHT - 3, COLOR_THEME->LAY_STATUS_SMETER_COLOR);
			...
			LCDDriver_Fill_RectWH(LAY_STATUS_BAR_X_OFFSET + smeter_peak_x, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + 2, 2, LAY_STATUS_BAR_HEIGHT - 3, COLOR_THEME->LAY_STATUS_SMETER_PEAK_COLOR);
			
			// stripe
			LCD_drawSMeter();
			LCDDriver_Fill_RectWH(LAY_STATUS_BAR_X_OFFSET + (uint16_t)s_width, LAY_STATUS_Y_OFFSET + 5, 2, LAY_STATUS_SMETER_MARKER_HEIGHT, COLOR_THEME->LAY_STATUS_SMETER_STRIPE_COLOR);
		...
		LCDDriver_printText(ctmp, LAY_STATUS_LABEL_DBM_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABEL_DBM_Y_OFFSET, COLOR_THEME->LAY_STATUS_LABEL_DBM_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
		...
		LCDDriver_printTextFont(ctmp, LAY_STATUS_LABEL_S_VAL_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABEL_S_VAL_Y_OFFSET, COLOR_THEME->LAY_STATUS_LABEL_S_VAL_COLOR, BG_COLOR, LAY_STATUS_LABEL_S_VAL_FONT);
	}
	else
	{
		//SWR
		...
		if (ref_width > fwd_width)
			ref_width = fwd_width;
		fwd_width -= ref_width;
		LCDDriver_Fill_RectWH(LAY_STATUS_BAR_X_OFFSET + 1, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + 2, fwd_width, LAY_STATUS_BAR_HEIGHT - 3, COLOR_THEME->LAY_STATUS_SMETER_COLOR);
		LCDDriver_Fill_RectWH(LAY_STATUS_BAR_X_OFFSET + 1 + fwd_width, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + 2, ref_width, LAY_STATUS_BAR_HEIGHT - 3, COLOR_THEME->LAY_STATUS_BAR_RIGHT_COLOR);
		...
		LCDDriver_printText(ctmp, LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_PMETER_WIDTH + LAY_STATUS_TX_ALC_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABELS_OFFSET_Y, COLOR_THEME->LAY_STATUS_BAR_LABELS_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
		...
		LCDDriver_Fill_RectWH(LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_PMETER_WIDTH + LAY_STATUS_ALC_BAR_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + 2, alc_level_width, LAY_STATUS_BAR_HEIGHT - 3, COLOR_THEME->LAY_STATUS_SMETER_COLOR);
		if (alc_level < 100)
			LCDDriver_Fill_RectWH(LAY_STATUS_BAR_X_OFFSET + LAY_STATUS_PMETER_WIDTH + LAY_STATUS_ALC_BAR_X_OFFSET + alc_level_width, LAY_STATUS_Y_OFFSET + LAY_STATUS_BAR_Y_OFFSET + 2, LAY_STATUS_AMETER_WIDTH - alc_level_width, LAY_STATUS_BAR_HEIGHT - 3, COLOR_THEME->LAY_STATUS_LABEL_NOTCH_COLOR);
	}
	...
	LCDDriver_printText(buff, LAY_STATUS_LABEL_BW_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABEL_BW_Y_OFFSET, COLOR_THEME->LAY_STATUS_LABEL_BW_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	//RIT
	if (TRX.CLAR)
	...
	addSymbols(buff, buff, 12, " ", true);
	LCDDriver_printText(buff, LAY_STATUS_LABEL_RIT_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABEL_RIT_Y_OFFSET, COLOR_THEME->LAY_STATUS_LABEL_RIT_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	//THERMAL
	sprintf(buff, "RF:%d MB:%d", (int16_t)TRX_RF_Temperature, (int16_t)TRX_STM32_TEMPERATURE);
	addSymbols(buff, buff, 12, " ", true);
	LCDDriver_printText(buff, LAY_STATUS_LABEL_THERM_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABEL_THERM_Y_OFFSET, COLOR_THEME->LAY_STATUS_LABEL_THERM_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	//NOTCH
	...
	addSymbols(buff, buff, 12, " ", true);
	LCDDriver_printText(buff, LAY_STATUS_LABEL_NOTCH_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABEL_NOTCH_Y_OFFSET, COLOR_THEME->LAY_STATUS_LABEL_NOTCH_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	//FFT BW
	if (TRX.FFT_Zoom == 1)
	...
	LCDDriver_printText(buff, LAY_STATUS_LABEL_FFT_BW_X_OFFSET, LAY_STATUS_Y_OFFSET + LAY_STATUS_LABEL_FFT_BW_Y_OFFSET, COLOR_THEME->LAY_STATUS_LABELS_BW_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	...
	if (TRX_ADC_OTR && !TRX_on_TX())
		LCDDriver_printText("OVR", LAY_STATUS_ERR_OFFSET_X, LAY_STATUS_ERR_OFFSET_Y, COLOR_THEME->LAY_STATUS_ERR_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	if (TRX_DAC_OTR)
		LCDDriver_printText("OVR", LAY_STATUS_ERR_OFFSET_X, LAY_STATUS_ERR_OFFSET_Y, COLOR_THEME->LAY_STATUS_ERR_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	...
	if (WM8731_Buffer_underrun && !TRX_on_TX())
		LCDDriver_printText("WBF", LAY_STATUS_ERR_OFFSET_X + LAY_STATUS_ERR2_OFFSET_X, LAY_STATUS_ERR_OFFSET_Y, COLOR_THEME->LAY_STATUS_ERR_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	if (FPGA_Buffer_underrun && TRX_on_TX())
		LCDDriver_printText("FBF", LAY_STATUS_ERR_OFFSET_X + LAY_STATUS_ERR2_OFFSET_X, LAY_STATUS_ERR_OFFSET_Y, COLOR_THEME->LAY_STATUS_ERR_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	if (RX_USB_AUDIO_underrun)
		LCDDriver_printText("UBF", LAY_STATUS_ERR_OFFSET_X + LAY_STATUS_ERR2_OFFSET_X, LAY_STATUS_ERR_OFFSET_Y, COLOR_THEME->LAY_STATUS_ERR_COLOR, BG_COLOR, LAY_STATUS_LABELS_FONT_SIZE);
	...
	if (redraw || (Hours != Last_showed_Hours))
	{
		...
		LCDDriver_printTextFont(ctmp, LAY_CLOCK_POS_HRS_X, LAY_CLOCK_POS_Y, COLOR_THEME->LAY_CLOCK_COLOR, BG_COLOR, LAY_CLOCK_FONT);
		LCDDriver_printTextFont(":", LCDDriver_GetCurrentXOffset(), LAY_CLOCK_POS_Y, COLOR_THEME->LAY_CLOCK_COLOR, BG_COLOR, LAY_CLOCK_FONT);
	...
	if (redraw || (Minutes != Last_showed_Minutes))
	{
		...
		addSymbols(ctmp, ctmp, 2, "0", false);
		LCDDriver_printTextFont(ctmp, LAY_CLOCK_POS_MIN_X, LAY_CLOCK_POS_Y, COLOR_THEME->LAY_CLOCK_COLOR, BG_COLOR, LAY_CLOCK_FONT);
		LCDDriver_printTextFont(":", LCDDriver_GetCurrentXOffset(), LAY_CLOCK_POS_Y, COLOR_THEME->LAY_CLOCK_COLOR, BG_COLOR, LAY_CLOCK_FONT);
	...
	if (redraw || (Seconds != Last_showed_Seconds))
	{
		...
		addSymbols(ctmp, ctmp, 2, "0", false);
		LCDDriver_printTextFont(ctmp, LAY_CLOCK_POS_SEC_X, LAY_CLOCK_POS_Y, COLOR_THEME->LAY_CLOCK_COLOR, BG_COLOR, LAY_CLOCK_FONT);
...
static void LCD_displayTextBar(void)
{
	...
	if (TRX.CWDecoder && (CurrentVFO()->Mode == TRX_MODE_CW_L || CurrentVFO()->Mode == TRX_MODE_CW_U || CurrentVFO()->Mode == TRX_MODE_LOOPBACK))
	{
		...
		LCDDriver_printText(ctmp, 0, LCD_HEIGHT - LAY_FFT_CWDECODER_OFFSET + 1, COLOR_THEME->LAY_CLOCK_COLOR, BG_COLOR, LAY_TEXTBAR_FONT);
		LCDDriver_printText((char *)&CW_Decoder_Text, LAY_TEXTBAR_TEXT_X_OFFSET, LCD_HEIGHT - LAY_FFT_CWDECODER_OFFSET + 1, COLOR_THEME->LAY_CLOCK_COLOR, BG_COLOR, LAY_TEXTBAR_FONT);
	}
...
void LCD_showInfo(char text[], bool autohide)
{
	...
	uint16_t x1, y1, w, h;
	LCDDriver_getTextBounds(text, 0, 0, &x1, &y1, &w, &h, (GFXfont *)&FreeSans12pt7b);
	LCDDriver_printTextFont(text, LCD_WIDTH / 2  - w / 2, LCD_HEIGHT / 2 - h / 2, COLOR_THEME->LAY_CLOCK_COLOR, BG_COLOR, (GFXfont *)&FreeSans12pt7b);
	if(autohide)
	{
		HAL_Delay(2000);
		LCD_busy = false;
...
static void LCD_printTooltip(void)
{
	...
	{
		LCDDriver_Fill_RectWH(LAY_TOOLTIP_POS_X - w / 2, LAY_TOOLTIP_POS_Y, w + LAY_TOOLTIP_MARGIN * 2, h + LAY_TOOLTIP_MARGIN * 2, COLOR_THEME->LAY_TOOLTIP_BACK_COLOR);
		LCDDriver_drawRectXY(LAY_TOOLTIP_POS_X - w / 2, LAY_TOOLTIP_POS_Y, LAY_TOOLTIP_POS_X - w / 2 + w + LAY_TOOLTIP_MARGIN * 2, LAY_TOOLTIP_POS_Y + h + LAY_TOOLTIP_MARGIN * 2, COLOR_THEME->LAY_TOOLTIP_BORD_COLOR);
		Tooltip_first_draw = false;
	}
	LCDDriver_printTextFont(Tooltip_string, LAY_TOOLTIP_POS_X - w / 2 + LAY_TOOLTIP_MARGIN, LAY_TOOLTIP_POS_Y + LAY_TOOLTIP_MARGIN + h, COLOR_THEME->LAY_TOOLTIP_FORE_COLOR, COLOR_THEME->LAY_TOOLTIP_BACK_COLOR, (GFXfont *)&FreeSans12pt7b);
