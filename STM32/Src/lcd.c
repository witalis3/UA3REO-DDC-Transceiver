...
// display information about the operation of the transceiver
	...
	if (TRX.ATT_DB < 1.0f)
		sprintf(buff, "ATT");
	printButton(LAYOUT->TOPBUTTONS_ATT_X, LAYOUT->TOPBUTTONS_ATT_Y, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, buff, (TRX.ATT && TRX.ATT_DB > 0.5f), true, false, 0, FRONTPANEL_BUTTONHANDLER_ATT, FRONTPANEL_BUTTONHANDLER_ATTHOLD, COLOR->BUTTON_TEXT, COLOR->BUTTON_INACTIVE_TEXT);
