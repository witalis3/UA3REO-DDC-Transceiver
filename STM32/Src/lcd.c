...
static void LCD_displayStatusInfoGUI(void)
{
	...
	//VFO indicator
	LCDDriver_Fill_RectWH(0, (LAY_STATUS_Y_OFFSET + LAY_STATUS_VFO_Y_OFFSET - LAY_STATUS_VFO_BLOCK_HEIGHT + 3), LAY_FREQ_LEFT_MARGIN, LAY_STATUS_VFO_BLOCK_HEIGHT, BACKGROUND_COLOR);
	if (!TRX.current_vfo) //VFO-A
	{
		if (!TRX.Dual_RX)
			LCDDriver_printTextFont(" A", LAY_STATUS_VFO_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_VFO_Y_OFFSET), LAY_STATUS_RX_COLOR, BACKGROUND_COLOR, LAY_STATUS_TXRX_FONT);
		else if (TRX.Dual_RX_Type == VFO_A_AND_B)
			LCDDriver_printTextFont("A&B", LAY_STATUS_VFO_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_VFO_Y_OFFSET), LAY_STATUS_RX_COLOR, BACKGROUND_COLOR, LAY_STATUS_TXRX_FONT);
	...
	{
		if (!TRX.Dual_RX)
			LCDDriver_printTextFont(" B", LAY_STATUS_VFO_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_VFO_Y_OFFSET), LAY_STATUS_RX_COLOR, BACKGROUND_COLOR, LAY_STATUS_TXRX_FONT);
		else if (TRX.Dual_RX_Type == VFO_A_AND_B)
			LCDDriver_printTextFont("B&A", LAY_STATUS_VFO_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_VFO_Y_OFFSET), LAY_STATUS_RX_COLOR, BACKGROUND_COLOR, LAY_STATUS_TXRX_FONT);
		else if (TRX.Dual_RX_Type == VFO_A_PLUS_B)
			LCDDriver_printTextFont("B+A", LAY_STATUS_VFO_X_OFFSET, (LAY_STATUS_Y_OFFSET + LAY_STATUS_VFO_Y_OFFSET), LAY_STATUS_RX_COLOR, BACKGROUND_COLOR, LAY_STATUS_TXRX_FONT);
	}
