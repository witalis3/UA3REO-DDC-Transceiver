...
// display information about the operation of the transceiver
	...
	printButton(LAYOUT->TOPBUTTONS_SQL_X, LAYOUT->TOPBUTTONS_SQL_Y, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "SQL", TRX.Squelch, true, false, 0, FRONTPANEL_BUTTONHANDLER_SQL, FRONTPANEL_BUTTONHANDLER_SQL, COLOR->BUTTON_TEXT, COLOR->BUTTON_INACTIVE_TEXT);
