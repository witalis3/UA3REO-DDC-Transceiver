...
static void LCD_displayBottomButtons(bool redraw)
{
	...
	uint16_t curr_x = 0;
	#define arrow_butt_width (LAYOUT->BOTTOM_BUTTONS_ONE_WIDTH / 2 + 4)
	printButton(0, LAYOUT->BOTTOM_BUTTONS_BLOCK_TOP, arrow_butt_width, LAYOUT->BOTTOM_BUTTONS_BLOCK_HEIGHT, "<-", true, false, false, 0, FRONTPANEL_BUTTONHANDLER_LEFT_ARR, FRONTPANEL_BUTTONHANDLER_LEFT_ARR, COLOR->BUTTON_TEXT, COLOR->BUTTON_INACTIVE_TEXT);
		curr_x += arrow_butt_width;
	...
	printButton(curr_x, LAYOUT->BOTTOM_BUTTONS_BLOCK_TOP, arrow_butt_width, LAYOUT->BOTTOM_BUTTONS_BLOCK_HEIGHT, "->", true, false, false, 0, FRONTPANEL_BUTTONHANDLER_RIGHT_ARR, FRONTPANEL_BUTTONHANDLER_RIGHT_ARR, COLOR->BUTTON_TEXT, COLOR->BUTTON_INACTIVE_TEXT);
#endif
