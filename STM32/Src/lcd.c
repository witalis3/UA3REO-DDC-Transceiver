...
{ // display the top buttons
	...
	printInfo(LAY_TOPBUTTONS_LOCK_X, LAY_TOPBUTTONS_LOCK_Y, LAY_TOPBUTTONS_LOCK_W, LAY_TOPBUTTONS_LOCK_H, "LOCK", COLOR_THEME->COLOR_BUTTON_BACKGROUND, COLOR_RED, COLOR_THEME->COLOR_BUTTON_INACTIVE_TEXT, TRX.Locked);
	#endif
