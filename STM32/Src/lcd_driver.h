...
extern void LCDDriver_printTextInMemory(char text[], uint16_t x, uint16_t y, uint16_t color, uint16_t bg, uint8_t size, uint16_t *buffer, uint16_t buffer_w, uint16_t buffer_h);
