...
#define LAY_TOPBUTTONS_SECOND_LINE_Y (LAY_TOPBUTTONS_Y1 + LAY_TOPBUTTONS_HEIGHT + LAY_TOPBUTTONS_TB_MARGIN)
...
#define LAY_FFT_FFTWTF_POS_Y ((uint16_t)(LCD_HEIGHT - LAY_FFT_HEIGHT_STYLE1 - LAY_WTF_HEIGHT_STYLE1))    // start of FFT and waterfall
