...
static void SDCOMM_EXPORT_SETT_handler(void)
{
	...
	if (f_open(&File, "wolf.ini", FA_CREATE_ALWAYS | FA_WRITE) == FR_OK)
	{
		...
		if (res)
		{
			...
			SD_WRITE_SETT_LINE("CALIBRATE.BPF_7_START", (uint32_t *)&CALIBRATE.BPF_6_START, SYSMENU_UINT32);
			SD_WRITE_SETT_LINE("CALIBRATE.BPF_7_END", (uint32_t *)&CALIBRATE.BPF_6_END, SYSMENU_UINT32);
			SD_WRITE_SETT_LINE("CALIBRATE.BPF_8_START", (uint32_t *)&CALIBRATE.BPF_6_START, SYSMENU_UINT32);
			SD_WRITE_SETT_LINE("CALIBRATE.BPF_8_END", (uint32_t *)&CALIBRATE.BPF_6_END, SYSMENU_UINT32);
			SD_WRITE_SETT_LINE("CALIBRATE.BPF_9_START", (uint32_t *)&CALIBRATE.BPF_6_START, SYSMENU_UINT32);
			SD_WRITE_SETT_LINE("CALIBRATE.BPF_9_END", (uint32_t *)&CALIBRATE.BPF_6_END, SYSMENU_UINT32);
...
static void SDCOMM_PARSE_SETT_LINE(char *line)
{
	...
	if (strcmp(name, "CALIBRATE.BPF_7_START") == 0)
		CALIBRATE.BPF_7_START = uintval;
	if (strcmp(name, "CALIBRATE.BPF_7_END") == 0)
		CALIBRATE.BPF_7_END = uintval;
	if (strcmp(name, "CALIBRATE.BPF_8_START") == 0)
		CALIBRATE.BPF_8_START = uintval;
	if (strcmp(name, "CALIBRATE.BPF_8_END") == 0)
		CALIBRATE.BPF_8_END = uintval;
	if (strcmp(name, "CALIBRATE.BPF_9_START") == 0)
		CALIBRATE.BPF_9_START = uintval;
	if (strcmp(name, "CALIBRATE.BPF_9_END") == 0)
		CALIBRATE.BPF_9_END = uintval;
