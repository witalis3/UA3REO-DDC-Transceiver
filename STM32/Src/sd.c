...
static void SDCOMM_EXPORT_SETT_handler(void)
{
	...
	if (f_open(&File, "wolf.ini", FA_CREATE_ALWAYS | FA_WRITE) == FR_OK)
	{
		...
		if (res)
		{
			...
			SD_WRITE_SETT_LINE("CALIBRATE.CICFIR_GAINER_48K_2", (uint32_t *)&CALIBRATE.CICFIR_GAINER_48K_val, SYSMENU_UINT8);
			SD_WRITE_SETT_LINE("CALIBRATE.CICFIR_GAINER_96K_2", (uint32_t *)&CALIBRATE.CICFIR_GAINER_96K_val, SYSMENU_UINT8);
			SD_WRITE_SETT_LINE("CALIBRATE.CICFIR_GAINER_192K_2", (uint32_t *)&CALIBRATE.CICFIR_GAINER_192K_val, SYSMENU_UINT8);
			SD_WRITE_SETT_LINE("CALIBRATE.CICFIR_GAINER_384K_2", (uint32_t *)&CALIBRATE.CICFIR_GAINER_384K_val, SYSMENU_UINT8);
			SD_WRITE_SETT_LINE("CALIBRATE.DAC_GAINER_2", (uint32_t *)&CALIBRATE.DAC_GAINER_val, SYSMENU_UINT8);
			SD_WRITE_SETT_LINE("CALIBRATE.TXCICFIR_GAINER_2", (uint32_t *)&CALIBRATE.TXCICFIR_GAINER_val, SYSMENU_UINT8);
...
static void SDCOMM_PARSE_SETT_LINE(char *line)
{
	...
	if (strcmp(name, "CALIBRATE.CICFIR_GAINER_48K_2") == 0)
		CALIBRATE.CICFIR_GAINER_48K_val = (uint8_t)uintval;
	if (strcmp(name, "CALIBRATE.CICFIR_GAINER_96K_2") == 0)
		CALIBRATE.CICFIR_GAINER_96K_val = (uint8_t)uintval;
	if (strcmp(name, "CALIBRATE.CICFIR_GAINER_192K_2") == 0)
		CALIBRATE.CICFIR_GAINER_192K_val = (uint8_t)uintval;
	if (strcmp(name, "CALIBRATE.CICFIR_GAINER_384K_2") == 0)
		CALIBRATE.CICFIR_GAINER_384K_val = (uint8_t)uintval;
	if (strcmp(name, "CALIBRATE.TXCICFIR_GAINER_2") == 0)
		CALIBRATE.TXCICFIR_GAINER_val = (uint8_t)uintval;
	if (strcmp(name, "CALIBRATE.DAC_GAINER_2") == 0)
	...
	if (strcmp(name, "CALIBRATE.EXT_70cm") == 0) CALIBRATE.EXT_70cm = (uint8_t)uintval;
	if (strcmp(name, "CALIBRATE.EXT_TRANSV_70cm") == 0) CALIBRATE.EXT_TRANSV_70cm = (uint8_t)uintval;
	if (strcmp(name, "CALIBRATE.EXT_TRANSV_23cm") == 0) CALIBRATE.EXT_TRANSV_23cm = (uint8_t)uintval;
	if (strcmp(name, "CALIBRATE.EXT_TRANSV_13cm") == 0) CALIBRATE.EXT_TRANSV_13cm = (uint8_t)uintval;
	if (strcmp(name, "CALIBRATE.EXT_TRANSV_6cm") == 0) CALIBRATE.EXT_TRANSV_6cm = (uint8_t)uintval;
	if (strcmp(name, "CALIBRATE.EXT_TRANSV_3cm") == 0) CALIBRATE.EXT_TRANSV_3cm = (uint8_t)uintval;
