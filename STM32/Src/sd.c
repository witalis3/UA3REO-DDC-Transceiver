...
static void SDCOMM_EXPORT_SETT_handler(void) {
	...
	if (f_open(&File, "wolf.ini", FA_CREATE_ALWAYS | FA_WRITE) == FR_OK) {
		...
		if (res) {
			...
			SD_WRITE_SETT_LINE("TRX.ANT_selected", (uint64_t *)&TRX.ANT_selected, SYSMENU_BOOLEAN);
			SD_WRITE_SETT_LINE("TRX.ANT_mode", (uint64_t *)&TRX.ANT_mode, SYSMENU_BOOLEAN);
			...
			SD_WRITE_SETT_LINE("TRX.RX_AGC_Hold", (uint64_t *)&TRX.RX_AGC_Hold, SYSMENU_UINT16);
			...
			SD_WRITE_SETT_LINE("TRX.CW_LPF_Filter", (uint64_t *)&TRX.CW_LPF_Filter, SYSMENU_UINT16);
			SD_WRITE_SETT_LINE("TRX.DIGI_LPF_Filter", (uint64_t *)&TRX.DIGI_LPF_Filter, SYSMENU_UINT16);
			SD_WRITE_SETT_LINE("TRX.SSB_LPF_RX_Filter", (uint64_t *)&TRX.SSB_LPF_RX_Filter, SYSMENU_UINT16);
			SD_WRITE_SETT_LINE("TRX.SSB_LPF_TX_Filter", (uint64_t *)&TRX.SSB_LPF_TX_Filter, SYSMENU_UINT16);
			SD_WRITE_SETT_LINE("TRX.SSB_HPF_RX_Filter", (uint64_t *)&TRX.SSB_HPF_RX_Filter, SYSMENU_UINT16);
			SD_WRITE_SETT_LINE("TRX.SSB_HPF_TX_Filter", (uint64_t *)&TRX.SSB_HPF_TX_Filter, SYSMENU_UINT16);
			SD_WRITE_SETT_LINE("TRX.AM_LPF_RX_Filter", (uint64_t *)&TRX.AM_LPF_RX_Filter, SYSMENU_UINT16);
			...
			// CALIBRATION
			SD_WRITE_SETT_LINE("CALIBRATE.ENCODER_INVERT", (uint64_t *)&CALIBRATE.ENCODER_INVERT, SYSMENU_BOOLEAN);
			...
			SD_WRITE_SETT_LINE("CALIBRATE.EXT_TRANSV_70cm", (uint64_t *)&CALIBRATE.EXT_TRANSV_70cm, SYSMENU_UINT8);
			SD_WRITE_SETT_LINE("CALIBRATE.EXT_TRANSV_23cm", (uint64_t *)&CALIBRATE.EXT_TRANSV_23cm, SYSMENU_UINT8);
			SD_WRITE_SETT_LINE("CALIBRATE.EXT_TRANSV_13cm", (uint64_t *)&CALIBRATE.EXT_TRANSV_13cm, SYSMENU_UINT8);
			SD_WRITE_SETT_LINE("CALIBRATE.EXT_TRANSV_6cm", (uint64_t *)&CALIBRATE.EXT_TRANSV_6cm, SYSMENU_UINT8);
			SD_WRITE_SETT_LINE("CALIBRATE.EXT_TRANSV_3cm", (uint64_t *)&CALIBRATE.EXT_TRANSV_3cm, SYSMENU_UINT8);
			SD_WRITE_SETT_LINE("CALIBRATE.EXT_TRANSV_QO100", (uint64_t *)&CALIBRATE.EXT_TRANSV_QO100, SYSMENU_UINT8);
			...
			SD_WRITE_SETT_LINE("CALIBRATE.INA226_EN", (uint64_t *)&CALIBRATE.INA226_EN, SYSMENU_BOOLEAN); // Tisho
			SD_WRITE_SETT_LINE("CALIBRATE.INA226_CurCalc", (uint64_t *)&CALIBRATE.INA226_CurCalc, SYSMENU_FLOAT32);
			...
			for (uint8_t i = 0; i < BANDS_COUNT; i++) {
				...
				SD_WRITE_SETT_LINE(buff, (uint64_t *)&TRX.BANDS_SAVED_SETTINGS[i].ANT_selected, SYSMENU_BOOLEAN);
				sprintf(buff, "TRX.BANDS_SAVED_SETTINGS[%d].ANT_mode", i);
				SD_WRITE_SETT_LINE(buff, (uint64_t *)&TRX.BANDS_SAVED_SETTINGS[i].ANT_mode, SYSMENU_BOOLEAN);
				...
				SD_WRITE_SETT_LINE(buff, (uint64_t *)&TRX.BANDS_SAVED_SETTINGS[i].ANT1_ATU_I, SYSMENU_UINT8);
				sprintf(buff, "TRX.BANDS_SAVED_SETTINGS[%d].ANT1_ATU_C", i);
				SD_WRITE_SETT_LINE(buff, (uint64_t *)&TRX.BANDS_SAVED_SETTINGS[i].ANT1_ATU_C, SYSMENU_UINT8);
				sprintf(buff, "TRX.BANDS_SAVED_SETTINGS[%d].ANT2_ATU_I", i);
				SD_WRITE_SETT_LINE(buff, (uint64_t *)&TRX.BANDS_SAVED_SETTINGS[i].ANT2_ATU_I, SYSMENU_UINT8);
				sprintf(buff, "TRX.BANDS_SAVED_SETTINGS[%d].ANT2_ATU_C", i);
				SD_WRITE_SETT_LINE(buff, (uint64_t *)&TRX.BANDS_SAVED_SETTINGS[i].ANT2_ATU_C, SYSMENU_UINT8);
