...
#define LAY_TOPBUTTONS_FAST_X (LAY_TOPBUTTONS_NB_X + LAY_TOPBUTTONS_NB_W)
...
#define LAY_TOPBUTTONS_LOCK_X (LAY_TOPBUTTONS_MUTE_X + LAY_TOPBUTTONS_MUTE_W)
...
#define LAY_FREQ_B_DELIMITER_X1_OFFSET (LAY_FREQ_B_LEFT + 145)
...
#define LAY_FFT_WTF_POS_Y ((uint16_t)(LCD_HEIGHT - LAY_FFT_HEIGHT_STYLE1 - LAY_WTF_HEIGHT_STYLE1 - BOTTOM_BUTTONS_BLOCK_HEIGHT))    // start of FFT and waterfall
