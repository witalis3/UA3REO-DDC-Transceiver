...
extern "C" constexpr STRUCT_LAYOUT_THEME LAYOUT_THEMES[LAYOUT_THEMES_COUNT] = {
    // Default
    {
        ...
        .FREQ_B_BLOCK_HEIGHT =
            (uint16_t)(LAYOUT_THEMES[0].FREQ_B_HEIGHT + LAYOUT_THEMES[0].FREQ_B_TOP_OFFSET + LAYOUT_THEMES[0].FREQ_B_BOTTOM_OFFSET),
        .FREQ_B_Y_TOP = 0,
        ...
        .STATUS_TX_LABELS_SWR_X = (uint16_t)(LAYOUT_THEMES[0].STATUS_BAR_X_OFFSET + LAYOUT_THEMES[0].STATUS_TX_LABELS_OFFSET_X +
                                             LAYOUT_THEMES[0].STATUS_SMETER_TXLABELS_PADDING),
        .STATUS_TX_LABELS_FWD_X = (uint16_t)(LAYOUT_THEMES[0].STATUS_BAR_X_OFFSET + LAYOUT_THEMES[0].STATUS_TX_LABELS_OFFSET_X +
                                             LAYOUT_THEMES[0].STATUS_SMETER_TXLABELS_MARGIN + LAYOUT_THEMES[0].STATUS_SMETER_TXLABELS_PADDING),
        .STATUS_TX_LABELS_REF_X =
            (uint16_t)(LAYOUT_THEMES[0].STATUS_BAR_X_OFFSET + LAYOUT_THEMES[0].STATUS_TX_LABELS_OFFSET_X +
                       LAYOUT_THEMES[0].STATUS_SMETER_TXLABELS_MARGIN * 2 + LAYOUT_THEMES[0].STATUS_SMETER_TXLABELS_PADDING),
        ...
        .BOTTOM_BUTTONS_ONE_WIDTH =
            (uint16_t)((LCD_WIDTH - LAYOUT_THEMES[0].BOTTOM_BUTTONS_ARROWS_WIDTH * 2) / LAYOUT_THEMES[0].BOTTOM_BUTTONS_COUNT),
        // FFT and waterfall
        ...
        .FFT_FFTWTF_POS_Y = (uint16_t)(LCD_HEIGHT - LAYOUT_THEMES[0].FFT_HEIGHT_STYLE1 - LAYOUT_THEMES[0].WTF_HEIGHT_STYLE1 -
                                       LAYOUT_THEMES[0].BOTTOM_BUTTONS_BLOCK_HEIGHT),
        .FFT_FFTWTF_BOTTOM =
            (uint16_t)(LAYOUT_THEMES[0].FFT_FFTWTF_POS_Y + LAYOUT_THEMES[0].FFT_HEIGHT_STYLE1 + LAYOUT_THEMES[0].WTF_HEIGHT_STYLE1),
    ...
    // analog meter
    {
        ...
        .FREQ_B_BOTTOM_OFFSET = 8,
        .FREQ_B_BLOCK_HEIGHT =
            (uint16_t)(LAYOUT_THEMES[1].FREQ_B_HEIGHT + LAYOUT_THEMES[1].FREQ_B_TOP_OFFSET + LAYOUT_THEMES[1].FREQ_B_BOTTOM_OFFSET),
        .FREQ_B_Y_TOP = 0,
        ...
        .STATUS_TX_LABELS_SWR_X = (uint16_t)(LAYOUT_THEMES[1].STATUS_BAR_X_OFFSET + LAYOUT_THEMES[1].STATUS_TX_LABELS_OFFSET_X +
                                             LAYOUT_THEMES[1].STATUS_SMETER_TXLABELS_PADDING),
        .STATUS_TX_LABELS_FWD_X = (uint16_t)(LAYOUT_THEMES[1].STATUS_BAR_X_OFFSET + LAYOUT_THEMES[1].STATUS_TX_LABELS_OFFSET_X +
                                             LAYOUT_THEMES[1].STATUS_SMETER_TXLABELS_MARGIN + LAYOUT_THEMES[1].STATUS_SMETER_TXLABELS_PADDING),
        .STATUS_TX_LABELS_REF_X =
            (uint16_t)(LAYOUT_THEMES[1].STATUS_BAR_X_OFFSET + LAYOUT_THEMES[1].STATUS_TX_LABELS_OFFSET_X +
                       LAYOUT_THEMES[1].STATUS_SMETER_TXLABELS_MARGIN * 2 + LAYOUT_THEMES[1].STATUS_SMETER_TXLABELS_PADDING),
    ...
    // Classic
    {
        ...
        .FFT_PRINT_SIZE = LAYOUT_THEMES[0].FFT_PRINT_SIZE,
        .FFT_CWDECODER_OFFSET = LAYOUT_THEMES[0].FFT_CWDECODER_OFFSET,
        .FFT_FFTWTF_POS_Y = (uint16_t)(LCD_HEIGHT - LAYOUT_THEMES[3].FFT_HEIGHT_STYLE1 - LAYOUT_THEMES[3].WTF_HEIGHT_STYLE1 -
                                       LAYOUT_THEMES[3].BOTTOM_BUTTONS_BLOCK_HEIGHT - LAYOUT_THEMES[3].TOPBUTTONS_HEIGHT),
        .FFT_FFTWTF_BOTTOM =
            (uint16_t)(LAYOUT_THEMES[3].FFT_FFTWTF_POS_Y + LAYOUT_THEMES[3].FFT_HEIGHT_STYLE1 + LAYOUT_THEMES[3].WTF_HEIGHT_STYLE1),
        .FFT_FREQLABELS_HEIGHT = LAYOUT_THEMES[0].FFT_FREQLABELS_HEIGHT,
        // system menu
        .SYSMENU_FONT_SIZE = LAYOUT_THEMES[0].SYSMENU_FONT_SIZE,
        .SYSMENU_X1 = LAYOUT_THEMES[0].SYSMENU_X1,
    ...
    // analog meter "CN"
    {
        ...
        .STATUS_MODE_X_OFFSET = LAYOUT_THEMES[6].STATUS_MODE_LOOP_X,
        /*********************************************/
        .STATUS_MODE_Y_OFFSET = -62,
        ...
        .FFT_FFTWTF_BOTTOM =
            (uint16_t)(LAYOUT_THEMES[6].FFT_FFTWTF_POS_Y + LAYOUT_THEMES[6].FFT_HEIGHT_STYLE1 + LAYOUT_THEMES[6].WTF_HEIGHT_STYLE1),
        .FFT_FREQLABELS_HEIGHT = LAYOUT_THEMES[0].FFT_FREQLABELS_HEIGHT,
        // system menu
        .SYSMENU_FONT_SIZE = LAYOUT_THEMES[0].SYSMENU_FONT_SIZE,
        .SYSMENU_X1 = LAYOUT_THEMES[0].SYSMENU_X1,
