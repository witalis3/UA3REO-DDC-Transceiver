...
extern "C" constexpr STRUCT_LAYOUT_THEME LAYOUT_THEMES[LAYOUT_THEMES_COUNT] =
    ...
    // analog meter "Analog+"
      ...
      .STATUS_IFGAIN_BAR_OFFSET_X = LAYOUT_THEMES[4].STATUS_IFGAIN_BAR_OFFSET_X,
			...
			.STATUS_MODE_LOOP_X =(uint16_t)(LAYOUT_THEMES[6].STATUS_MODE_IQ_X + 34),
			.STATUS_MODE_X_OFFSET = LAYOUT_THEMES[6].STATUS_MODE_IQ_X,
			/*********************************************/
			.STATUS_MODE_Y_OFFSET = -62,
			...
			.BOTTOM_BUTTONS_ONE_WIDTH = LAYOUT_THEMES[0].BOTTOM_BUTTONS_ONE_WIDTH,
			// FFT and waterfall
			.FFT_HEIGHT_STYLE1 = 95+5,
			.WTF_HEIGHT_STYLE1 = 195,
			.FFT_HEIGHT_STYLE2 = 145+5,
			.WTF_HEIGHT_STYLE2 = 145,
			.FFT_HEIGHT_STYLE3 = 165+5,
			.WTF_HEIGHT_STYLE3 = 125,
			.FFT_HEIGHT_STYLE4 = 195+5,
			.WTF_HEIGHT_STYLE4 = 95,
			.FFT_HEIGHT_STYLE5 = 255+5,
			.WTF_HEIGHT_STYLE5 = 35,
			.FFT_PRINT_SIZE = LAYOUT_THEMES[0].FFT_PRINT_SIZE,
			.FFT_CWDECODER_OFFSET = LAYOUT_THEMES[0].FFT_CWDECODER_OFFSET,
			.FFT_FFTWTF_POS_Y = 150,
			.FFT_FFTWTF_BOTTOM = LAYOUT_THEMES[0].FFT_FFTWTF_BOTTOM,
			.FFT_FREQLABELS_HEIGHT = LAYOUT_THEMES[0].FFT_FREQLABELS_HEIGHT,
			// system menu
			.SYSMENU_FONT_SIZE = LAYOUT_THEMES[0].SYSMENU_FONT_SIZE,
