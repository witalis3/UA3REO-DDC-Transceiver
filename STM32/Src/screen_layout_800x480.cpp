...
extern "C" constexpr STRUCT_LAYOUT_THEME LAYOUT_THEMES[LAYOUT_THEMES_COUNT] =
	{
		...
		},
		{
			...
			// frequency output VFO-A
			.FREQ_A_LEFT = 245,
			.FREQ_X_OFFSET_100 = (uint16_t)(LAYOUT_THEMES[1].FREQ_A_LEFT + 37),
			.FREQ_X_OFFSET_10 = (uint16_t)(LAYOUT_THEMES[1].FREQ_A_LEFT + 73),
			.FREQ_X_OFFSET_1 = (uint16_t)(LAYOUT_THEMES[1].FREQ_A_LEFT + 113),
			.FREQ_X_OFFSET_KHZ = (uint16_t)(LAYOUT_THEMES[1].FREQ_A_LEFT + 125),
			...
			.FREQ_DELIMITER_X2_OFFSET = (uint16_t)(LAYOUT_THEMES[1].FREQ_X_OFFSET_HZ - 10),
			// frequency output VFO-B
			.FREQ_B_LEFT = (LCD_WIDTH - 315),
			.FREQ_B_X_OFFSET_100 = (uint16_t)(LAYOUT_THEMES[1].FREQ_B_LEFT + 37),
			.FREQ_B_X_OFFSET_10 = (uint16_t)(LAYOUT_THEMES[1].FREQ_B_LEFT + 73),
			.FREQ_B_X_OFFSET_1 = (uint16_t)(LAYOUT_THEMES[1].FREQ_B_LEFT + 105),
			.FREQ_B_X_OFFSET_KHZ = (uint16_t)(LAYOUT_THEMES[1].FREQ_B_LEFT + 125),
			...
			.FREQ_B_DELIMITER_X2_OFFSET = (uint16_t)(LAYOUT_THEMES[1].FREQ_B_X_OFFSET_HZ - 10),
			// display statuses under frequency
