	...
	{
		{
			...
			.FREQ_B_DELIMITER_X1_OFFSET = (uint16_t)(LAYOUT_THEMES[0].FREQ_B_LEFT + 136),
			...
			.STATUS_LABEL_RIT_X_OFFSET = 532,
			.STATUS_LABEL_RIT_Y_OFFSET = 20,
			.STATUS_LABEL_THERM_X_OFFSET = 582,
			...
			// FFT and waterfall
			.FFT_HEIGHT_STYLE1 = 130,
			.WTF_HEIGHT_STYLE1 = 170,
