...
static void SYSMENU_HANDL_CALIB_AM_DC_RATE(int8_t direction);
...
const static struct sysmenu_item_handler sysmenu_screen_handlers[] =
	{
...
#endif
#ifdef LAY_800x480
		{"Layout Theme", SYSMENU_ENUMR, NULL, (uint32_t *)&TRX.LayoutThemeId, SYSMENU_HANDL_SCREEN_LAYOUT_THEME, {"Default", "Analog", "7 Segment"}},
#endif
		...
		{"FFT Grid", SYSMENU_ENUM, NULL, (uint32_t *)&TRX.FFT_Grid, SYSMENU_HANDL_SCREEN_FFT_Grid, {"NO", "Top", "All", "Bott"}},
...
const static struct sysmenu_item_handler sysmenu_calibration_handlers[] =
	{
		...
		{"AM DC Rate", SYSMENU_UINT8, NULL, (uint32_t *)&CALIBRATE.AM_DC_RATE, SYSMENU_HANDL_CALIB_AM_DC_RATE},
...
static void SYSMENU_HANDL_CALIB_AM_DC_RATE(int8_t direction)
{
	CALIBRATE.AM_DC_RATE += direction;
	if (CALIBRATE.AM_DC_RATE < 1)
		CALIBRATE.AM_DC_RATE = 1;
	if (CALIBRATE.AM_DC_RATE > 200)
		CALIBRATE.AM_DC_RATE = 200;
}
