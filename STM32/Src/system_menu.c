...
const static struct sysmenu_item_handler sysmenu_calibration_handlers[] =
	{
		...
		{"BPF 7 START", SYSMENU_UINT32, (uint32_t *)&CALIBRATE.BPF_7_START, SYSMENU_HANDL_CALIB_BPF_7_START},
		{"BPF 7 END", SYSMENU_UINT32, (uint32_t *)&CALIBRATE.BPF_7_END, SYSMENU_HANDL_CALIB_BPF_7_END},
		{"BPF 8 START", SYSMENU_UINT32, (uint32_t *)&CALIBRATE.BPF_8_START, SYSMENU_HANDL_CALIB_BPF_8_START},
		{"BPF 8 END", SYSMENU_UINT32, (uint32_t *)&CALIBRATE.BPF_8_END, SYSMENU_HANDL_CALIB_BPF_8_END},
		{"BPF 9 START", SYSMENU_UINT32, (uint32_t *)&CALIBRATE.BPF_9_START, SYSMENU_HANDL_CALIB_BPF_9_START},
		{"BPF 9 END", SYSMENU_UINT32, (uint32_t *)&CALIBRATE.BPF_9_END, SYSMENU_HANDL_CALIB_BPF_9_END},
		#endif
		#ifdef RF_UNIT_QRP_V1
		...
		{"RTC COARSE CALIBR", SYSMENU_UINT8, (uint32_t *)&CALIBRATE.RTC_Coarse_Calibration, SYSMENU_HANDL_CALIB_RTC_COARSE_CALIBRATION},
		{"RTC FINE CALIBR", SYSMENU_INT16, (uint32_t *)&CALIBRATE.RTC_Calibration, SYSMENU_HANDL_CALIB_RTC_CALIBRATION},
};
...
static void SYSMENU_HANDL_CALIB_BPF_7_START(int8_t direction)
{
	CALIBRATE.BPF_7_START += direction * 100000;
	if (CALIBRATE.BPF_7_START < 1)
		CALIBRATE.BPF_7_START = 1;
	if (CALIBRATE.BPF_7_START > 999999999)
		CALIBRATE.BPF_7_START = 999999999;
}

static void SYSMENU_HANDL_CALIB_BPF_7_END(int8_t direction)
{
	CALIBRATE.BPF_7_END += direction * 100000;
	if (CALIBRATE.BPF_7_END < 1)
		CALIBRATE.BPF_7_END = 1;
	if (CALIBRATE.BPF_7_END > 999999999)
		CALIBRATE.BPF_7_END = 999999999;
}

static void SYSMENU_HANDL_CALIB_BPF_8_START(int8_t direction)
{
	CALIBRATE.BPF_8_START += direction * 100000;
	if (CALIBRATE.BPF_8_START < 1)
		CALIBRATE.BPF_8_START = 1;
	if (CALIBRATE.BPF_8_START > 999999999)
		CALIBRATE.BPF_8_START = 999999999;
}

static void SYSMENU_HANDL_CALIB_BPF_8_END(int8_t direction)
{
	CALIBRATE.BPF_8_END += direction * 100000;
	if (CALIBRATE.BPF_8_END < 1)
		CALIBRATE.BPF_8_END = 1;
	if (CALIBRATE.BPF_8_END > 999999999)
		CALIBRATE.BPF_8_END = 999999999;
}

static void SYSMENU_HANDL_CALIB_BPF_9_START(int8_t direction)
{
	CALIBRATE.BPF_9_START += direction * 100000;
	if (CALIBRATE.BPF_9_START < 1)
		CALIBRATE.BPF_9_START = 1;
	if (CALIBRATE.BPF_9_START > 999999999)
		CALIBRATE.BPF_9_START = 999999999;
}

static void SYSMENU_HANDL_CALIB_BPF_9_END(int8_t direction)
{
	CALIBRATE.BPF_9_END += direction * 100000;
	if (CALIBRATE.BPF_9_END < 1)
		CALIBRATE.BPF_9_END = 1;
	if (CALIBRATE.BPF_9_END > 999999999)
		CALIBRATE.BPF_9_END = 999999999;
}
