...
extern "C" constexpr STRUCT_LAYOUT_THEME LAYOUT_THEMES[LAYOUT_THEMES_COUNT] = {
    // Default
    {
        ...
        .TOPBUTTONS_ATT_X =
            (float32_t)(LAYOUT_THEMES[0].TOPBUTTONS_PRE_X + LAYOUT_THEMES[0].TOPBUTTONS_WIDTH + LAYOUT_THEMES[0].TOPBUTTONS_LR_MARGIN),
        .TOPBUTTONS_ATT_Y = LAYOUT_THEMES[0].TOPBUTTONS_Y1,
        .TOPBUTTONS_PGA_X =
            (float32_t)(LAYOUT_THEMES[0].TOPBUTTONS_ATT_X + LAYOUT_THEMES[0].TOPBUTTONS_WIDTH + LAYOUT_THEMES[0].TOPBUTTONS_LR_MARGIN),
        .TOPBUTTONS_PGA_Y = LAYOUT_THEMES[0].TOPBUTTONS_Y1,
        .TOPBUTTONS_DRV_X =
            (float32_t)(LAYOUT_THEMES[0].TOPBUTTONS_PGA_X + LAYOUT_THEMES[0].TOPBUTTONS_WIDTH + LAYOUT_THEMES[0].TOPBUTTONS_LR_MARGIN),
        .TOPBUTTONS_DRV_Y = LAYOUT_THEMES[0].TOPBUTTONS_Y1,
        .TOPBUTTONS_AGC_X =
            (float32_t)(LAYOUT_THEMES[0].TOPBUTTONS_DRV_X + LAYOUT_THEMES[0].TOPBUTTONS_WIDTH + LAYOUT_THEMES[0].TOPBUTTONS_LR_MARGIN),
        .TOPBUTTONS_AGC_Y = LAYOUT_THEMES[0].TOPBUTTONS_Y1,
        .TOPBUTTONS_SECOND_LINE_Y =
            (uint16_t)(LAYOUT_THEMES[0].TOPBUTTONS_Y1 + LAYOUT_THEMES[0].TOPBUTTONS_HEIGHT + LAYOUT_THEMES[0].TOPBUTTONS_TB_MARGIN),
        ...
        .TOPBUTTONS_NB_X =
            (float32_t)(LAYOUT_THEMES[0].TOPBUTTONS_DNR_X + LAYOUT_THEMES[0].TOPBUTTONS_WIDTH + LAYOUT_THEMES[0].TOPBUTTONS_LR_MARGIN),
        .TOPBUTTONS_NB_Y = LAYOUT_THEMES[0].TOPBUTTONS_SECOND_LINE_Y,
        .TOPBUTTONS_FAST_X =
            (float32_t)(LAYOUT_THEMES[0].TOPBUTTONS_NB_X + LAYOUT_THEMES[0].TOPBUTTONS_WIDTH + LAYOUT_THEMES[0].TOPBUTTONS_LR_MARGIN),
        .TOPBUTTONS_FAST_Y = LAYOUT_THEMES[0].TOPBUTTONS_SECOND_LINE_Y,
        .TOPBUTTONS_MUTE_X =
            (float32_t)(LAYOUT_THEMES[0].TOPBUTTONS_FAST_X + LAYOUT_THEMES[0].TOPBUTTONS_WIDTH + LAYOUT_THEMES[0].TOPBUTTONS_LR_MARGIN),
        .TOPBUTTONS_MUTE_Y = LAYOUT_THEMES[0].TOPBUTTONS_SECOND_LINE_Y,
        .TOPBUTTONS_LOCK_X =
            (float32_t)(LAYOUT_THEMES[0].TOPBUTTONS_MUTE_X + LAYOUT_THEMES[0].TOPBUTTONS_WIDTH + LAYOUT_THEMES[0].TOPBUTTONS_LR_MARGIN),
