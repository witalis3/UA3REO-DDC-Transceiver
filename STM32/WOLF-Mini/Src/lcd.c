...
static void LCD_displayTopButtons(bool redraw) { // display the top buttons
	...
	if (!TRX.BluetoothAudio_Enabled) {
		...
		printInfo(LAYOUT->TOPBUTTONS_MUTE_X, LAYOUT->TOPBUTTONS_MUTE_Y, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "BT", COLOR->BUTTON_STATUS_BACKGROUND, COLOR_RED,
