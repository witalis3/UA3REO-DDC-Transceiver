...
static void LCD_displayTopButtons(bool redraw) { // display the top buttons
	...
	printInfo(LAYOUT->TOPBUTTONS_X1, LAYOUT->TOPBUTTONS_PRE_Y, LAYOUT->TOPBUTTONS_WIDTH-10, LAYOUT->TOPBUTTONS_HEIGHT, "DRV", BG_COLOR, COLOR->BUTTON_TEXT,
	...
	printInfo(LAYOUT->TOPBUTTONS_ATT_X, LAYOUT->TOPBUTTONS_ATT_Y, LAYOUT->TOPBUTTONS_WIDTH+5, LAYOUT->TOPBUTTONS_HEIGHT, buff, BG_COLOR, COLOR->BUTTON_TEXT,
	          COLOR->BUTTON_INACTIVE_TEXT, (TRX.ATT && TRX.ATT_DB >= 1.0f));
	printInfo(LAYOUT->TOPBUTTONS_PGA_X, LAYOUT->TOPBUTTONS_PGA_Y, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "SQL", BG_COLOR, COLOR->BUTTON_TEXT,
	          COLOR->BUTTON_INACTIVE_TEXT, CurrentVFO->SQL);
	if  (TRX.SPLIT_Enabled)
	{
	printInfo(LAYOUT->TOPBUTTONS_DRV_X, LAYOUT->TOPBUTTONS_DRV_Y, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "SPLIT", BG_COLOR, COLOR->BUTTON_TEXT,
	          COLOR->BUTTON_INACTIVE_TEXT, TRX.SPLIT_Enabled);
	} else {
	printInfo(LAYOUT->TOPBUTTONS_DRV_X, LAYOUT->TOPBUTTONS_DRV_Y, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "RIT", BG_COLOR, COLOR->BUTTON_TEXT,
	          COLOR->BUTTON_INACTIVE_TEXT, TRX.RIT_Enabled || TRX.XIT_Enabled);		
	}
	printInfo(LAYOUT->TOPBUTTONS_AGC_X, LAYOUT->TOPBUTTONS_AGC_Y, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "AGC", BG_COLOR, COLOR->BUTTON_TEXT,
	          COLOR->BUTTON_INACTIVE_TEXT, CurrentVFO->AGC);
		if (CurrentVFO->DNR_Type == 1) {
		printInfo(LAYOUT->TOPBUTTONS_DNR_X, LAYOUT->TOPBUTTONS_DNR_Y, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "DNR", BG_COLOR, COLOR->BUTTON_TEXT,
		          COLOR->BUTTON_INACTIVE_TEXT, true);
	} else if (CurrentVFO->DNR_Type == 2) {
		printInfo(LAYOUT->TOPBUTTONS_DNR_X, LAYOUT->TOPBUTTONS_DNR_Y, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "DNR2", BG_COLOR, COLOR->BUTTON_TEXT,
		          COLOR->BUTTON_INACTIVE_TEXT, true);
	} else {
		printInfo(LAYOUT->TOPBUTTONS_DNR_X, LAYOUT->TOPBUTTONS_DNR_Y, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "DNR", BG_COLOR, COLOR->BUTTON_TEXT,
		...
		printInfo(LAYOUT->TOPBUTTONS_NB_X, LAYOUT->TOPBUTTONS_NB_Y+1, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "NB", BG_COLOR, COLOR->BUTTON_TEXT,
		          COLOR->BUTTON_INACTIVE_TEXT, false);
	}
	if (TRX.NOISE_BLANKER1 == true && TRX.NOISE_BLANKER2 == false) {
		printInfo(LAYOUT->TOPBUTTONS_NB_X, LAYOUT->TOPBUTTONS_NB_Y+1, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "NB1", BG_COLOR, COLOR->BUTTON_TEXT,
		          COLOR->BUTTON_INACTIVE_TEXT, false);
	}
	if (TRX.NOISE_BLANKER1 == false && TRX.NOISE_BLANKER2 == true) {
		printInfo(LAYOUT->TOPBUTTONS_NB_X, LAYOUT->TOPBUTTONS_NB_Y+1, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "NB2", BG_COLOR, COLOR->BUTTON_TEXT,
		          COLOR->BUTTON_INACTIVE_TEXT, false);
	}
	if (TRX.NOISE_BLANKER1 == true && TRX.NOISE_BLANKER2 == true) {
		printInfo(LAYOUT->TOPBUTTONS_NB_X, LAYOUT->TOPBUTTONS_NB_Y+1, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "NB12", BG_COLOR, COLOR->BUTTON_TEXT,
		          COLOR->BUTTON_INACTIVE_TEXT, true);
	}
	if (!TRX.BluetoothAudio_Enabled) {
		printInfo(LAYOUT->TOPBUTTONS_MUTE_X, LAYOUT->TOPBUTTONS_MUTE_Y+1, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "MUTE", BG_COLOR, COLOR_RED,
		          COLOR->BUTTON_INACTIVE_TEXT, TRX.Mute);
	} else {
		printInfo(LAYOUT->TOPBUTTONS_MUTE_X, LAYOUT->TOPBUTTONS_MUTE_Y+1, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "BT", BG_COLOR, COLOR_RED,
		          COLOR->BUTTON_INACTIVE_TEXT, TRX.BluetoothAudio_Enabled);
	}
	if (TRX.Locked) {	
	printInfoSmall(LAYOUT->TOPBUTTONS_MUTE_X+5, LAYOUT->TOPBUTTONS_LOCK_Y+50, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "LOCK", 
		          COLOR_RED, BG_COLOR, COLOR->BUTTON_INACTIVE_TEXT, TRX.Locked);          
	} else {
    printInfoSmall(LAYOUT->TOPBUTTONS_MUTE_X+5, LAYOUT->TOPBUTTONS_LOCK_Y+50, LAYOUT->TOPBUTTONS_WIDTH, LAYOUT->TOPBUTTONS_HEIGHT, "FAST",
              BG_COLOR, COLOR->BUTTON_TEXT, COLOR->BUTTON_INACTIVE_TEXT, TRX.Fast);	
	}
...
static void LCD_displayFreqV2(uint64_t freqV2) {
	...
	LCDDriver_printText(buff, LAYOUT->FREQ_DELIMITER_X2_OFFSET - 60, LAYOUT->FREQ_Y_BASELINE + LAYOUT->FREQ_DELIMITER_Y_OFFSET -12, COLOR->FREQ_HZ,
	                    BG_COLOR, 2);
	LCDDriver_printText(".", LAYOUT->FREQ_DELIMITER_X2_OFFSET - 25, LAYOUT->FREQ_Y_BASELINE + LAYOUT->FREQ_DELIMITER_Y_OFFSET -12, COLOR->FREQ_HZ,
	                    BG_COLOR, 2);
	addSymbols(buff, LCD_freq_string_kHz, 3, "0", false);
	LCDDriver_printText(buff, LAYOUT->FREQ_DELIMITER_X2_OFFSET - 15, LAYOUT->FREQ_Y_BASELINE + LAYOUT->FREQ_DELIMITER_Y_OFFSET -12, COLOR->FREQ_HZ,
	                    BG_COLOR, 2);
	LCDDriver_printText(".", LAYOUT->FREQ_DELIMITER_X2_OFFSET + 20, LAYOUT->FREQ_Y_BASELINE + LAYOUT->FREQ_DELIMITER_Y_OFFSET -12, COLOR->FREQ_HZ,
	                    BG_COLOR, 2);
	addSymbols(buff, LCD_freq_string_Hz, 3, "0", false);
	LCDDriver_printText(buff, LAYOUT->FREQ_DELIMITER_X2_OFFSET + 30, LAYOUT->FREQ_Y_BASELINE + LAYOUT->FREQ_DELIMITER_Y_OFFSET -12, COLOR->FREQ_HZ,
	                    BG_COLOR, 2);
}
//MEMO 
...
static void LCD_displayFreqInfo(bool redraw) { // display the frequency on the screen
	...
	if (redraw) {
		...
		LCDDriver_printTextFont(".", LAYOUT->FREQ_DELIMITER_X1_OFFSET, LAYOUT->FREQ_Y_BASELINE - 25 + LAYOUT->FREQ_DELIMITER_Y_OFFSET, COLOR->FREQ_KHZ,
		                        BG_COLOR, LAYOUT->FREQ_FONT);
		LCDDriver_printTextFont(".", LAYOUT->FREQ_DELIMITER_X2_OFFSET, LAYOUT->FREQ_Y_BASELINE - 25 + LAYOUT->FREQ_DELIMITER_Y_OFFSET, COLOR->FREQ_HZ,
		                        BG_COLOR, LAYOUT->FREQ_FONT);
...
{
	printInfoSmall(LAYOUT->STATUS_ANT_X_OFFSET+2, (LAYOUT->STATUS_Y_OFFSET + LAYOUT->STATUS_ANT_Y_OFFSET+1), LAYOUT->STATUS_ANT_BLOCK_WIDTH, LAYOUT->STATUS_ANT_BLOCK_HEIGHT-7, enc2_state_str,
              BG_COLOR, COLOR->STATUS_RX, COLOR->STATUS_RX, true);
} else {
	printInfoSmall(LAYOUT->STATUS_ANT_X_OFFSET+4, (LAYOUT->STATUS_Y_OFFSET + LAYOUT->STATUS_ANT_Y_OFFSET+1), LAYOUT->STATUS_ANT_BLOCK_WIDTH, LAYOUT->STATUS_ANT_BLOCK_HEIGHT-7, enc2_state_str,
              BG_COLOR, COLOR->STATUS_RX, COLOR->STATUS_RX, true);	
}
