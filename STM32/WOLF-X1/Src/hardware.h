...
#define DAC_CLOCK_PLL1 (ADC_CLOCK * 5ULL / 8ULL)                            // DAC generator frequency PLL 1 (76.800.000)
#define DAC_CLOCK_PLL2 (ADC_CLOCK * 7ULL / 8ULL)                            // DAC generator frequency PLL 2 (107.520.000)
