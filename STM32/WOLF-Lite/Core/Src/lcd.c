...
static void LCD_displayTopButtons(bool redraw) { // display the top buttons
	...
	printInfo(LAYOUT->TOPBUTTONS_ATT_X, LAYOUT->TOPBUTTONS_ATT_Y, LAYOUT->TOPBUTTONS_WIDTH+6, LAYOUT->TOPBUTTONS_HEIGHT, buff, COLOR->BACKGROUND, COLOR->BUTTON_TEXT, COLOR->BUTTON_INACTIVE_TEXT,
	          (TRX.ATT && TRX.ATT_DB >= 1.0f));
	printInfo(LAYOUT->TOPBUTTONS_PGA_X+3, LAYOUT->TOPBUTTONS_PGA_Y - 1, LAYOUT->TOPBUTTONS_WIDTH-2, LAYOUT->TOPBUTTONS_HEIGHT, "SQL", COLOR->BACKGROUND, COLOR->BUTTON_TEXT,
