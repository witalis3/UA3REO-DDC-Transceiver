...
void HAL_I2S_MspInit(I2S_HandleTypeDef *hi2s) {
	...
	if (hi2s->Instance == SPI3) {
		...
		* in RCC_CFGR register! Hence we need to set it manually here! * WARNING: A bug fix is also needed in __HAL_RCC_GET_I2S_SOURCE()
		  Line 6131 stm32f4xx_hal_rcc_ex.h -> #define __HAL_RCC_GET_I2S_SOURCE() ((uint32_t)(READ_BIT(RCC->CFGR, RCC_CFGR_I2SSRC)) >>
		RCC_CFGR_I2SSRC_Pos)
		*/
...
static void HAL_FSMC_MspInit(void) {
	...
	*/
	...
	GPIO_InitStruct.Pin = GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15 | GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_4 |
...
static void HAL_FSMC_MspDeInit(void) {
	...
	*/
	...
	HAL_GPIO_DeInit(GPIOD, GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15 | GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_4 |
	                           GPIO_PIN_5 | GPIO_PIN_7);
