...
static void LCD_displayStatusInfoBar(bool redraw)
{
    ...
    if(TRX.LayoutThemeId == 4) // layout theme Default+
    {
        ...
        LCDDriver_Fill_RectWH(LAYOUT->STATUS_IFGAIN_BAR_OFFSET_X + 15, LAYOUT->STATUS_Y_OFFSET + LAYOUT->STATUS_IFGAIN_BAR_OFFSET_Y, LAYOUT->STATUS_IFGAIN_BAR_WIDTH, LAYOUT->STATUS_IFGAIN_BAR_HEIGTH, COLOR->IFGAIN_BAR_BG);
        LCDDriver_Fill_RectWH(LAYOUT->STATUS_IFGAIN_BAR_OFFSET_X + 15, LAYOUT->STATUS_Y_OFFSET + LAYOUT->STATUS_IFGAIN_BAR_OFFSET_Y, (uint16_t)(TRX.IF_Gain / (60.0f / LAYOUT->STATUS_IFGAIN_BAR_WIDTH)), LAYOUT->STATUS_IFGAIN_BAR_HEIGTH, COLOR->IFGAIN_BAR_FG);
        ...
        LCDDriver_Fill_RectWH(LAYOUT->STATUS_AFGAIN_BAR_OFFSET_X + 15, LAYOUT->STATUS_Y_OFFSET + LAYOUT->STATUS_AFGAIN_BAR_OFFSET_Y, LAYOUT->STATUS_AFGAIN_BAR_WIDTH, LAYOUT->STATUS_AFGAIN_BAR_HEIGTH, COLOR->AFGAIN_BAR_BG);
        LCDDriver_Fill_RectWH(LAYOUT->STATUS_AFGAIN_BAR_OFFSET_X + 15, LAYOUT->STATUS_Y_OFFSET + LAYOUT->STATUS_AFGAIN_BAR_OFFSET_Y, (uint16_t)(TRX.Volume / (MAX_VOLUME_VALUE / LAYOUT->STATUS_AFGAIN_BAR_WIDTH)), LAYOUT->STATUS_AFGAIN_BAR_HEIGTH, COLOR->AFGAIN_BAR_FG);
    }
    // THERMAL
#if (defined(LAY_800x480))
