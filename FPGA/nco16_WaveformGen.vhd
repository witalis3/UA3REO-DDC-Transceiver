...
END nco16_WaveformGen;


ARCHITECTURE rtl OF nco16_WaveformGen IS

  -- Component Declarations
  COMPONENT nco16_LookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : nco16_LookUpTableGen
    USE ENTITY work.nco16_LookUpTableGen(rtl);
...
BEGIN
  u_SineWave_inst : nco16_LookUpTableGen
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_CosineWave_inst : nco16_LookUpTableGen
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
