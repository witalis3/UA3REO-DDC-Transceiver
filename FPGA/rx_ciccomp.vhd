...
-- Generated on: 2021-02-11 23:35:36
-- -------------------------------------------------------------
...
--   Tap Sum         : s33,0 -> [-4294967296 4294967296)
...
ARCHITECTURE rtl OF rx_ciccomp IS
  ...
  -- Constants
  CONSTANT coeff1                         : signed(15 DOWNTO 0) := to_signed(246, 16); -- sfix16_En14
  CONSTANT coeff2                         : signed(15 DOWNTO 0) := to_signed(-289, 16); -- sfix16_En14
  CONSTANT coeff3                         : signed(15 DOWNTO 0) := to_signed(452, 16); -- sfix16_En14
  CONSTANT coeff4                         : signed(15 DOWNTO 0) := to_signed(-669, 16); -- sfix16_En14
  CONSTANT coeff5                         : signed(15 DOWNTO 0) := to_signed(952, 16); -- sfix16_En14
  CONSTANT coeff6                         : signed(15 DOWNTO 0) := to_signed(-1312, 16); -- sfix16_En14
  CONSTANT coeff7                         : signed(15 DOWNTO 0) := to_signed(1765, 16); -- sfix16_En14
  CONSTANT coeff8                         : signed(15 DOWNTO 0) := to_signed(-2329, 16); -- sfix16_En14
  CONSTANT coeff9                         : signed(15 DOWNTO 0) := to_signed(3029, 16); -- sfix16_En14
  CONSTANT coeff10                        : signed(15 DOWNTO 0) := to_signed(-3896, 16); -- sfix16_En14
  CONSTANT coeff11                        : signed(15 DOWNTO 0) := to_signed(4975, 16); -- sfix16_En14
  CONSTANT coeff12                        : signed(15 DOWNTO 0) := to_signed(-6335, 16); -- sfix16_En14
  CONSTANT coeff13                        : signed(15 DOWNTO 0) := to_signed(8077, 16); -- sfix16_En14
  CONSTANT coeff14                        : signed(15 DOWNTO 0) := to_signed(-10347, 16); -- sfix16_En14
  CONSTANT coeff15                        : signed(15 DOWNTO 0) := to_signed(13315, 16); -- sfix16_En14
  CONSTANT coeff16                        : signed(15 DOWNTO 0) := to_signed(-16820, 16); -- sfix16_En14
  CONSTANT coeff17                        : signed(15 DOWNTO 0) := to_signed(17515, 16); -- sfix16_En14

  -- Signals
  SIGNAL cur_count                        : unsigned(4 DOWNTO 0); -- ufix5
  SIGNAL phase_16                         : std_logic; -- boolean
  SIGNAL phase_0                          : std_logic; -- boolean
  SIGNAL delay_pipeline                   : delay_pipeline_type(0 TO 33); -- sfix32
  ...
  SIGNAL mul_temp                         : signed(48 DOWNTO 0); -- sfix49_En14
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      delay_pipeline(0 TO 33) <= (OTHERS => (OTHERS => '0'));
    ELSIF clk'event AND clk = '1' THEN
      IF phase_16 = '1' THEN
        delay_pipeline(0) <= signed(filter_in);
        delay_pipeline(1 TO 33) <= delay_pipeline(0 TO 32);
      END IF;
    END IF; 
  ...
  preaddmux_a1 <= delay_pipeline(0) WHEN ( cur_count = to_unsigned(0, 5) ) ELSE
                       ...
                       delay_pipeline(16);
  preaddmux_b1 <= delay_pipeline(33) WHEN ( cur_count = to_unsigned(0, 5) ) ELSE
                       delay_pipeline(32) WHEN ( cur_count = to_unsigned(1, 5) ) ELSE
                       delay_pipeline(31) WHEN ( cur_count = to_unsigned(2, 5) ) ELSE
                       delay_pipeline(30) WHEN ( cur_count = to_unsigned(3, 5) ) ELSE
                       delay_pipeline(29) WHEN ( cur_count = to_unsigned(4, 5) ) ELSE
                       delay_pipeline(28) WHEN ( cur_count = to_unsigned(5, 5) ) ELSE
                       delay_pipeline(27) WHEN ( cur_count = to_unsigned(6, 5) ) ELSE
                       delay_pipeline(26) WHEN ( cur_count = to_unsigned(7, 5) ) ELSE
                       delay_pipeline(25) WHEN ( cur_count = to_unsigned(8, 5) ) ELSE
                       delay_pipeline(24) WHEN ( cur_count = to_unsigned(9, 5) ) ELSE
                       delay_pipeline(23) WHEN ( cur_count = to_unsigned(10, 5) ) ELSE
                       delay_pipeline(22) WHEN ( cur_count = to_unsigned(11, 5) ) ELSE
                       delay_pipeline(21) WHEN ( cur_count = to_unsigned(12, 5) ) ELSE
                       delay_pipeline(20) WHEN ( cur_count = to_unsigned(13, 5) ) ELSE
                       delay_pipeline(19) WHEN ( cur_count = to_unsigned(14, 5) ) ELSE
                       delay_pipeline(18) WHEN ( cur_count = to_unsigned(15, 5) ) ELSE
                       delay_pipeline(17);
