...
-- Generated on: 2019-11-08 00:39:45
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF rx_ciccomp IS
  ...
  CONSTANT coeffphase1_1                  : signed(31 DOWNTO 0) := to_signed(146, 32); -- sfix32_En31
  CONSTANT coeffphase1_2                  : signed(31 DOWNTO 0) := to_signed(-4463, 32); -- sfix32_En31
  CONSTANT coeffphase1_3                  : signed(31 DOWNTO 0) := to_signed(34093, 32); -- sfix32_En31
  CONSTANT coeffphase1_4                  : signed(31 DOWNTO 0) := to_signed(-168233, 32); -- sfix32_En31
  CONSTANT coeffphase1_5                  : signed(31 DOWNTO 0) := to_signed(696583, 32); -- sfix32_En31
  CONSTANT coeffphase1_6                  : signed(31 DOWNTO 0) := to_signed(-3181680, 32); -- sfix32_En31
  CONSTANT coeffphase1_7                  : signed(31 DOWNTO 0) := to_signed(43343190, 32); -- sfix32_En31
  CONSTANT coeffphase1_8                  : signed(31 DOWNTO 0) := to_signed(-19941092, 32); -- sfix32_En31
  CONSTANT coeffphase1_9                  : signed(31 DOWNTO 0) := to_signed(2278055, 32); -- sfix32_En31
  CONSTANT coeffphase1_10                 : signed(31 DOWNTO 0) := to_signed(-526035, 32); -- sfix32_En31
  CONSTANT coeffphase1_11                 : signed(31 DOWNTO 0) := to_signed(124838, 32); -- sfix32_En31
  CONSTANT coeffphase1_12                 : signed(31 DOWNTO 0) := to_signed(-23775, 32); -- sfix32_En31
  CONSTANT coeffphase1_13                 : signed(31 DOWNTO 0) := to_signed(2709, 32); -- sfix32_En31
  CONSTANT coeffphase2_1                  : signed(31 DOWNTO 0) := to_signed(-27538, 32); -- sfix32_En31
  CONSTANT coeffphase2_2                  : signed(31 DOWNTO 0) := to_signed(442986, 32); -- sfix32_En31
  CONSTANT coeffphase2_3                  : signed(31 DOWNTO 0) := to_signed(-2581800, 32); -- sfix32_En31
  CONSTANT coeffphase2_4                  : signed(31 DOWNTO 0) := to_signed(9486521, 32); -- sfix32_En31
  CONSTANT coeffphase2_5                  : signed(31 DOWNTO 0) := to_signed(-27182938, 32); -- sfix32_En31
  CONSTANT coeffphase2_6                  : signed(31 DOWNTO 0) := to_signed(72933849, 32); -- sfix32_En31
  CONSTANT coeffphase2_7                  : signed(31 DOWNTO 0) := to_signed(-349365682, 32); -- sfix32_En31
  CONSTANT coeffphase2_8                  : signed(31 DOWNTO 0) := to_signed(-153228298, 32); -- sfix32_En31
  CONSTANT coeffphase2_9                  : signed(31 DOWNTO 0) := to_signed(48689929, 32); -- sfix32_En31
  CONSTANT coeffphase2_10                 : signed(31 DOWNTO 0) := to_signed(-18196583, 32); -- sfix32_En31
  CONSTANT coeffphase2_11                 : signed(31 DOWNTO 0) := to_signed(5860966, 32); -- sfix32_En31
  CONSTANT coeffphase2_12                 : signed(31 DOWNTO 0) := to_signed(-1372586, 32); -- sfix32_En31
  CONSTANT coeffphase2_13                 : signed(31 DOWNTO 0) := to_signed(173326, 32); -- sfix32_En31
  CONSTANT coeffphase3_1                  : signed(31 DOWNTO 0) := to_signed(-419, 32); -- sfix32_En31
  CONSTANT coeffphase3_2                  : signed(31 DOWNTO 0) := to_signed(7086, 32); -- sfix32_En31
  CONSTANT coeffphase3_3                  : signed(31 DOWNTO 0) := to_signed(-48082, 32); -- sfix32_En31
  CONSTANT coeffphase3_4                  : signed(31 DOWNTO 0) := to_signed(225122, 32); -- sfix32_En31
  CONSTANT coeffphase3_5                  : signed(31 DOWNTO 0) := to_signed(-924993, 32); -- sfix32_En31
  CONSTANT coeffphase3_6                  : signed(31 DOWNTO 0) := to_signed(4580792, 32); -- sfix32_En31
  CONSTANT coeffphase3_7                  : signed(31 DOWNTO 0) := to_signed(-139692024, 32); -- sfix32_En31
  CONSTANT coeffphase3_8                  : signed(31 DOWNTO 0) := to_signed(11107390, 32); -- sfix32_En31
  CONSTANT coeffphase3_9                  : signed(31 DOWNTO 0) := to_signed(-1665594, 32); -- sfix32_En31
  CONSTANT coeffphase3_10                 : signed(31 DOWNTO 0) := to_signed(397369, 32); -- sfix32_En31
  CONSTANT coeffphase3_11                 : signed(31 DOWNTO 0) := to_signed(-91833, 32); -- sfix32_En31
  CONSTANT coeffphase3_12                 : signed(31 DOWNTO 0) := to_signed(16262, 32); -- sfix32_En31
  CONSTANT coeffphase3_13                 : signed(31 DOWNTO 0) := to_signed(-1555, 32); -- sfix32_En31
  CONSTANT coeffphase4_1                  : signed(31 DOWNTO 0) := to_signed(51962, 32); -- sfix32_En31
  CONSTANT coeffphase4_2                  : signed(31 DOWNTO 0) := to_signed(-665392, 32); -- sfix32_En31
  CONSTANT coeffphase4_3                  : signed(31 DOWNTO 0) := to_signed(3444636, 32); -- sfix32_En31
  CONSTANT coeffphase4_4                  : signed(31 DOWNTO 0) := to_signed(-11884557, 32); -- sfix32_En31
  CONSTANT coeffphase4_5                  : signed(31 DOWNTO 0) := to_signed(33035295, 32); -- sfix32_En31
  CONSTANT coeffphase4_6                  : signed(31 DOWNTO 0) := to_signed(-90846868, 32); -- sfix32_En31
  CONSTANT coeffphase4_7                  : signed(31 DOWNTO 0) := to_signed(757437988, 32); -- sfix32_En31
  CONSTANT coeffphase4_8                  : signed(31 DOWNTO 0) := to_signed(115762736, 32); -- sfix32_En31
  CONSTANT coeffphase4_9                  : signed(31 DOWNTO 0) := to_signed(-40089485, 32); -- sfix32_En31
  CONSTANT coeffphase4_10                 : signed(31 DOWNTO 0) := to_signed(14760552, 32); -- sfix32_En31
  CONSTANT coeffphase4_11                 : signed(31 DOWNTO 0) := to_signed(-4524612, 32); -- sfix32_En31
  CONSTANT coeffphase4_12                 : signed(31 DOWNTO 0) := to_signed(968463, 32); -- sfix32_En31
  CONSTANT coeffphase4_13                 : signed(31 DOWNTO 0) := to_signed(-99312, 32); -- sfix32_En31
  CONSTANT coeffphase5_1                  : signed(31 DOWNTO 0) := to_signed(833, 32); -- sfix32_En31
  CONSTANT coeffphase5_2                  : signed(31 DOWNTO 0) := to_signed(-10880, 32); -- sfix32_En31
  CONSTANT coeffphase5_3                  : signed(31 DOWNTO 0) := to_signed(66852, 32); -- sfix32_En31
  CONSTANT coeffphase5_4                  : signed(31 DOWNTO 0) := to_signed(-299641, 32); -- sfix32_En31
  CONSTANT coeffphase5_5                  : signed(31 DOWNTO 0) := to_signed(1235372, 32); -- sfix32_En31
  CONSTANT coeffphase5_6                  : signed(31 DOWNTO 0) := to_signed(-6895946, 32); -- sfix32_En31
  CONSTANT coeffphase5_7                  : signed(31 DOWNTO 0) := to_signed(1292460930, 32); -- sfix32_En31
  CONSTANT coeffphase5_8                  : signed(31 DOWNTO 0) := to_signed(-6895946, 32); -- sfix32_En31
  CONSTANT coeffphase5_9                  : signed(31 DOWNTO 0) := to_signed(1235372, 32); -- sfix32_En31
  CONSTANT coeffphase5_10                 : signed(31 DOWNTO 0) := to_signed(-299641, 32); -- sfix32_En31
  CONSTANT coeffphase5_11                 : signed(31 DOWNTO 0) := to_signed(66852, 32); -- sfix32_En31
  CONSTANT coeffphase5_12                 : signed(31 DOWNTO 0) := to_signed(-10880, 32); -- sfix32_En31
  CONSTANT coeffphase5_13                 : signed(31 DOWNTO 0) := to_signed(833, 32); -- sfix32_En31
  CONSTANT coeffphase6_1                  : signed(31 DOWNTO 0) := to_signed(-99312, 32); -- sfix32_En31
  CONSTANT coeffphase6_2                  : signed(31 DOWNTO 0) := to_signed(968463, 32); -- sfix32_En31
  CONSTANT coeffphase6_3                  : signed(31 DOWNTO 0) := to_signed(-4524612, 32); -- sfix32_En31
  CONSTANT coeffphase6_4                  : signed(31 DOWNTO 0) := to_signed(14760552, 32); -- sfix32_En31
  CONSTANT coeffphase6_5                  : signed(31 DOWNTO 0) := to_signed(-40089485, 32); -- sfix32_En31
  CONSTANT coeffphase6_6                  : signed(31 DOWNTO 0) := to_signed(115762736, 32); -- sfix32_En31
  CONSTANT coeffphase6_7                  : signed(31 DOWNTO 0) := to_signed(757437988, 32); -- sfix32_En31
  CONSTANT coeffphase6_8                  : signed(31 DOWNTO 0) := to_signed(-90846868, 32); -- sfix32_En31
  CONSTANT coeffphase6_9                  : signed(31 DOWNTO 0) := to_signed(33035295, 32); -- sfix32_En31
  CONSTANT coeffphase6_10                 : signed(31 DOWNTO 0) := to_signed(-11884557, 32); -- sfix32_En31
  CONSTANT coeffphase6_11                 : signed(31 DOWNTO 0) := to_signed(3444636, 32); -- sfix32_En31
  CONSTANT coeffphase6_12                 : signed(31 DOWNTO 0) := to_signed(-665392, 32); -- sfix32_En31
  CONSTANT coeffphase6_13                 : signed(31 DOWNTO 0) := to_signed(51962, 32); -- sfix32_En31
  CONSTANT coeffphase7_1                  : signed(31 DOWNTO 0) := to_signed(-1555, 32); -- sfix32_En31
  CONSTANT coeffphase7_2                  : signed(31 DOWNTO 0) := to_signed(16262, 32); -- sfix32_En31
  CONSTANT coeffphase7_3                  : signed(31 DOWNTO 0) := to_signed(-91833, 32); -- sfix32_En31
  CONSTANT coeffphase7_4                  : signed(31 DOWNTO 0) := to_signed(397369, 32); -- sfix32_En31
  CONSTANT coeffphase7_5                  : signed(31 DOWNTO 0) := to_signed(-1665594, 32); -- sfix32_En31
  CONSTANT coeffphase7_6                  : signed(31 DOWNTO 0) := to_signed(11107390, 32); -- sfix32_En31
  CONSTANT coeffphase7_7                  : signed(31 DOWNTO 0) := to_signed(-139692024, 32); -- sfix32_En31
  CONSTANT coeffphase7_8                  : signed(31 DOWNTO 0) := to_signed(4580792, 32); -- sfix32_En31
  CONSTANT coeffphase7_9                  : signed(31 DOWNTO 0) := to_signed(-924993, 32); -- sfix32_En31
  CONSTANT coeffphase7_10                 : signed(31 DOWNTO 0) := to_signed(225122, 32); -- sfix32_En31
  CONSTANT coeffphase7_11                 : signed(31 DOWNTO 0) := to_signed(-48082, 32); -- sfix32_En31
  CONSTANT coeffphase7_12                 : signed(31 DOWNTO 0) := to_signed(7086, 32); -- sfix32_En31
  CONSTANT coeffphase7_13                 : signed(31 DOWNTO 0) := to_signed(-419, 32); -- sfix32_En31
  CONSTANT coeffphase8_1                  : signed(31 DOWNTO 0) := to_signed(173326, 32); -- sfix32_En31
  CONSTANT coeffphase8_2                  : signed(31 DOWNTO 0) := to_signed(-1372586, 32); -- sfix32_En31
  CONSTANT coeffphase8_3                  : signed(31 DOWNTO 0) := to_signed(5860966, 32); -- sfix32_En31
  CONSTANT coeffphase8_4                  : signed(31 DOWNTO 0) := to_signed(-18196583, 32); -- sfix32_En31
  CONSTANT coeffphase8_5                  : signed(31 DOWNTO 0) := to_signed(48689929, 32); -- sfix32_En31
  CONSTANT coeffphase8_6                  : signed(31 DOWNTO 0) := to_signed(-153228298, 32); -- sfix32_En31
  CONSTANT coeffphase8_7                  : signed(31 DOWNTO 0) := to_signed(-349365682, 32); -- sfix32_En31
  CONSTANT coeffphase8_8                  : signed(31 DOWNTO 0) := to_signed(72933849, 32); -- sfix32_En31
  CONSTANT coeffphase8_9                  : signed(31 DOWNTO 0) := to_signed(-27182938, 32); -- sfix32_En31
  CONSTANT coeffphase8_10                 : signed(31 DOWNTO 0) := to_signed(9486521, 32); -- sfix32_En31
  CONSTANT coeffphase8_11                 : signed(31 DOWNTO 0) := to_signed(-2581800, 32); -- sfix32_En31
  CONSTANT coeffphase8_12                 : signed(31 DOWNTO 0) := to_signed(442986, 32); -- sfix32_En31
  CONSTANT coeffphase8_13                 : signed(31 DOWNTO 0) := to_signed(-27538, 32); -- sfix32_En31
  CONSTANT coeffphase9_1                  : signed(31 DOWNTO 0) := to_signed(2709, 32); -- sfix32_En31
  CONSTANT coeffphase9_2                  : signed(31 DOWNTO 0) := to_signed(-23775, 32); -- sfix32_En31
  CONSTANT coeffphase9_3                  : signed(31 DOWNTO 0) := to_signed(124838, 32); -- sfix32_En31
  CONSTANT coeffphase9_4                  : signed(31 DOWNTO 0) := to_signed(-526035, 32); -- sfix32_En31
  CONSTANT coeffphase9_5                  : signed(31 DOWNTO 0) := to_signed(2278055, 32); -- sfix32_En31
  CONSTANT coeffphase9_6                  : signed(31 DOWNTO 0) := to_signed(-19941092, 32); -- sfix32_En31
  CONSTANT coeffphase9_7                  : signed(31 DOWNTO 0) := to_signed(43343190, 32); -- sfix32_En31
  CONSTANT coeffphase9_8                  : signed(31 DOWNTO 0) := to_signed(-3181680, 32); -- sfix32_En31
  CONSTANT coeffphase9_9                  : signed(31 DOWNTO 0) := to_signed(696583, 32); -- sfix32_En31
  CONSTANT coeffphase9_10                 : signed(31 DOWNTO 0) := to_signed(-168233, 32); -- sfix32_En31
  CONSTANT coeffphase9_11                 : signed(31 DOWNTO 0) := to_signed(34093, 32); -- sfix32_En31
  CONSTANT coeffphase9_12                 : signed(31 DOWNTO 0) := to_signed(-4463, 32); -- sfix32_En31
  CONSTANT coeffphase9_13                 : signed(31 DOWNTO 0) := to_signed(146, 32); -- sfix32_En31
  CONSTANT coeffphase10_1                 : signed(31 DOWNTO 0) := to_signed(-283845, 32); -- sfix32_En31
  CONSTANT coeffphase10_2                 : signed(31 DOWNTO 0) := to_signed(1901357, 32); -- sfix32_En31
  CONSTANT coeffphase10_3                 : signed(31 DOWNTO 0) := to_signed(-7498081, 32); -- sfix32_En31
  CONSTANT coeffphase10_4                 : signed(31 DOWNTO 0) := to_signed(22294129, 32); -- sfix32_En31
  CONSTANT coeffphase10_5                 : signed(31 DOWNTO 0) := to_signed(-59359023, 32); -- sfix32_En31
  CONSTANT coeffphase10_6                 : signed(31 DOWNTO 0) := to_signed(216822221, 32); -- sfix32_En31
  CONSTANT coeffphase10_7                 : signed(31 DOWNTO 0) := to_signed(216822221, 32); -- sfix32_En31
  CONSTANT coeffphase10_8                 : signed(31 DOWNTO 0) := to_signed(-59359023, 32); -- sfix32_En31
  CONSTANT coeffphase10_9                 : signed(31 DOWNTO 0) := to_signed(22294129, 32); -- sfix32_En31
  CONSTANT coeffphase10_10                : signed(31 DOWNTO 0) := to_signed(-7498081, 32); -- sfix32_En31
  CONSTANT coeffphase10_11                : signed(31 DOWNTO 0) := to_signed(1901357, 32); -- sfix32_En31
  CONSTANT coeffphase10_12                : signed(31 DOWNTO 0) := to_signed(-283845, 32); -- sfix32_En31
  CONSTANT coeffphase10_13                : signed(31 DOWNTO 0) := to_signed(0, 32); -- sfix32_En31
  ...
  SIGNAL sumofproducts_cast               : signed(75 DOWNTO 0); -- sfix76_En62
  SIGNAL acc_sum                          : signed(75 DOWNTO 0); -- sfix76_En62
  SIGNAL accreg_in                        : signed(75 DOWNTO 0); -- sfix76_En62
  SIGNAL accreg_out                       : signed(75 DOWNTO 0); -- sfix76_En62
  SIGNAL add_temp                         : signed(76 DOWNTO 0); -- sfix77_En62
  SIGNAL accreg_final                     : signed(75 DOWNTO 0); -- sfix76_En62
