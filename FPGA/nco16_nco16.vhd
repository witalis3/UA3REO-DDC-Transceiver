...
ARCHITECTURE rtl OF nco16_nco16 IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT nco16_NCO_HDL_Optimized
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : nco16_NCO_HDL_Optimized
    USE ENTITY work.nco16_NCO_HDL_Optimized(rtl);
...
BEGIN
  u_NCO_HDL_Optimized : nco16_NCO_HDL_Optimized
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              inc => phase,  -- uint32
