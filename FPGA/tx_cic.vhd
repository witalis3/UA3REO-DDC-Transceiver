...
-- Generated on: 2019-11-08 00:56:47
-- -------------------------------------------------------------
...
ENTITY tx_cic IS
   PORT( clk                             :   IN    std_logic; 
         ...
         filter_out                      :   OUT   std_logic_vector(13 DOWNTO 0); -- sfix14_En13
...
ARCHITECTURE rtl OF tx_cic IS
  ...
  -- Type Definitions
  -- Constants
  CONSTANT zeroconst                      : signed(17 DOWNTO 0) := to_signed(0, 18); -- sfix18_En15
  -- Signals
  ...
  SIGNAL section_cast1                    : signed(17 DOWNTO 0); -- sfix18_En15
  SIGNAL diff1                            : signed(17 DOWNTO 0); -- sfix18_En15
  SIGNAL section_out1                     : signed(17 DOWNTO 0); -- sfix18_En15
  SIGNAL sub_cast                         : signed(17 DOWNTO 0); -- sfix18_En15
  SIGNAL sub_cast_1                       : signed(17 DOWNTO 0); -- sfix18_En15
  SIGNAL sub_temp                         : signed(18 DOWNTO 0); -- sfix19_En15
  SIGNAL cic_pipeline1                    : signed(17 DOWNTO 0); -- sfix18_En15
  --   -- Section 2 Signals 
  SIGNAL section_in2                      : signed(17 DOWNTO 0); -- sfix18_En15
  ...
  SIGNAL cic_pipeline2                    : signed(17 DOWNTO 0); -- sfix18_En15
  SIGNAL upsampling                       : signed(17 DOWNTO 0); -- sfix18_En15
  --   -- Section 3 Signals 
  SIGNAL section_in3                      : signed(17 DOWNTO 0); -- sfix18_En15
  SIGNAL sum1                             : signed(17 DOWNTO 0); -- sfix18_En15
  SIGNAL section_out3                     : signed(17 DOWNTO 0); -- sfix18_En15
  ...
  --   -- Section 4 Signals 
  SIGNAL section_in4                      : signed(17 DOWNTO 0); -- sfix18_En15
  SIGNAL sum2                             : signed(17 DOWNTO 0); -- sfix18_En15
  SIGNAL section_out4                     : signed(17 DOWNTO 0); -- sfix18_En15
  ...
  --   
  SIGNAL output_register                  : signed(13 DOWNTO 0); -- sfix14_En13
...
BEGIN
  ...
  output_typeconvert <= section_out4(15 DOWNTO 2);
