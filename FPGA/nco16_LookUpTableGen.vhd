...
-- -------------------------------------------------------------
-- 
-- Module: nco16_LookUpTableGen
-- Source Path: nco16/NCO HDL Optimized/WaveformGen/LookUpTableGen
-- Hierarchy Level: 3
-- 
...
USE work.nco16_nco16_pkg.ALL;

ENTITY nco16_LookUpTableGen IS
...
END nco16_LookUpTableGen;


ARCHITECTURE rtl OF nco16_LookUpTableGen IS
  ...
  CONSTANT Lookup_Table2_table_data       : vector_of_unsigned4(0 TO 1023) := 
    (to_unsigned(16#0#, 4), to_unsigned(16#0#, 4), to_unsigned(16#0#, 4), to_unsigned(16#1#, 4),
     ...
     to_unsigned(16#3#, 4), to_unsigned(16#3#, 4), to_unsigned(16#3#, 4), to_unsigned(16#4#, 4),
     to_unsigned(16#4#, 4), to_unsigned(16#4#, 4), to_unsigned(16#4#, 4), to_unsigned(16#4#, 4),
     to_unsigned(16#4#, 4), to_unsigned(16#5#, 4), to_unsigned(16#5#, 4), to_unsigned(16#5#, 4),
     to_unsigned(16#5#, 4), to_unsigned(16#5#, 4), to_unsigned(16#6#, 4), to_unsigned(16#6#, 4),
     to_unsigned(16#0#, 4), to_unsigned(16#0#, 4), to_unsigned(16#0#, 4), to_unsigned(16#1#, 4),
     to_unsigned(16#1#, 4), to_unsigned(16#1#, 4), to_unsigned(16#1#, 4), to_unsigned(16#1#, 4),
     to_unsigned(16#1#, 4), to_unsigned(16#2#, 4), to_unsigned(16#2#, 4), to_unsigned(16#2#, 4),
     ...
     to_unsigned(16#4#, 4), to_unsigned(16#4#, 4), to_unsigned(16#4#, 4), to_unsigned(16#4#, 4),
     to_unsigned(16#4#, 4), to_unsigned(16#5#, 4), to_unsigned(16#5#, 4), to_unsigned(16#5#, 4),
     to_unsigned(16#5#, 4), to_unsigned(16#5#, 4), to_unsigned(16#5#, 4), to_unsigned(16#6#, 4),
     to_unsigned(16#0#, 4), to_unsigned(16#0#, 4), to_unsigned(16#0#, 4), to_unsigned(16#1#, 4),
     to_unsigned(16#1#, 4), to_unsigned(16#1#, 4), to_unsigned(16#1#, 4), to_unsigned(16#1#, 4),
     to_unsigned(16#1#, 4), to_unsigned(16#2#, 4), to_unsigned(16#2#, 4), to_unsigned(16#2#, 4),
     ...
     to_unsigned(16#0#, 4), to_unsigned(16#0#, 4), to_unsigned(16#0#, 4), to_unsigned(16#0#, 4),
     to_unsigned(16#0#, 4), to_unsigned(16#0#, 4), to_unsigned(16#0#, 4), to_unsigned(16#0#, 4),
     to_unsigned(16#0#, 4), to_unsigned(16#0#, 4), to_unsigned(16#0#, 4), to_unsigned(16#0#, 4));  -- ufix4 [1024]

  -- Signals
  SIGNAL lutaddr_unsigned                 : unsigned(14 DOWNTO 0);  -- ufix15
  SIGNAL lutaddrInReg                     : unsigned(14 DOWNTO 0) := to_unsigned(16#0000#, 15);  -- ufix15
  ...
  SIGNAL lut2addrp2                       : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL lut2addr                         : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL Lookup_Table2_k                  : unsigned(9 DOWNTO 0);  -- ufix10
...
BEGIN
  ...
  lut1addr <= lutaddrInReg(14 DOWNTO 5);
  ...
  lut2addrp1 <= lutaddrInReg(14 DOWNTO 10);

  lut2addrp2 <= lutaddrInReg(4 DOWNTO 0);
  ...
  Lookup_Table2_k <= to_unsigned(16#000#, 10) WHEN lut2addr = to_unsigned(16#000#, 10) ELSE
      to_unsigned(16#3FF#, 10) WHEN lut2addr = to_unsigned(16#3FF#, 10) ELSE
      lut2addr;
  ...
  lut2out_sf <= lut2out_extend srl 8;
