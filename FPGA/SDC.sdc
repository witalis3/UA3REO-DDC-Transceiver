...
set_output_delay -clock MAIN_PLL|altpll_component|auto_generated|pll1|clk[3] -max 36ps [get_ports {DCDC_SYNC}]
set_output_delay -clock MAIN_PLL|altpll_component|auto_generated|pll1|clk[3] -min 0ps [get_ports {DCDC_SYNC}]
set_output_delay -clock VCXO_PLL|altpll_component|auto_generated|pll1|clk[0] -max 36ps [get_ports {VCXO_CHARGE_PUMP}]
set_output_delay -clock VCXO_PLL|altpll_component|auto_generated|pll1|clk[0] -min 0ps [get_ports {VCXO_CHARGE_PUMP}]
