...
set_output_delay -clock clock_crystal -max 36ps [get_ports {STM32_DATA_BUS[*]}]
set_output_delay -clock clock_crystal -min 30ps [get_ports {STM32_DATA_BUS[*]}]
...
set_input_delay -clock clock_adc -max 0ps [get_ports STM32_DATA_BUS[*]]
set_input_delay -clock clock_adc -min -66ps [get_ports STM32_DATA_BUS[*]]
set_input_delay -clock clock_adc -max 0ps [get_ports STM32_SYNC]
set_input_delay -clock clock_adc -min -66ps [get_ports STM32_SYNC]
